...
static_assert(not is_list_constructible_v<unit_test_is_list_constructible_polymorphic_derived_2 &, unit_test_is_list_constructible_polymorphic_base &>);
static_assert(not is_list_constructible_v<unit_test_is_list_constructible_polymorphic_derived_3 &, unit_test_is_list_constructible_polymorphic_base &>);
static_assert(is_list_constructible_v<unit_test_is_list_constructible_polymorphic_base, unit_test_is_list_constructible_polymorphic_virtual_derived_1>);
static_assert(is_list_constructible_v<unit_test_is_list_constructible_polymorphic_base, unit_test_is_list_constructible_polymorphic_virtual_derived_2>);
static_assert(is_list_constructible_v<unit_test_is_list_constructible_polymorphic_base, unit_test_is_list_constructible_polymorphic_virtual_derived_final>);
static_assert(not is_list_constructible_v<unit_test_is_list_constructible_polymorphic_virtual_derived_1, unit_test_is_list_constructible_polymorphic_base>);
static_assert(not is_list_constructible_v<unit_test_is_list_constructible_polymorphic_virtual_derived_2, unit_test_is_list_constructible_polymorphic_base>);
static_assert(not is_list_constructible_v<unit_test_is_list_constructible_polymorphic_virtual_derived_final, unit_test_is_list_constructible_polymorphic_base>);
static_assert(not is_list_constructible_v<unit_test_is_list_constructible_polymorphic_virtual_derived_1, unit_test_is_list_constructible_polymorphic_derived_1>);
static_assert(not is_list_constructible_v<unit_test_is_list_constructible_polymorphic_virtual_derived_2, unit_test_is_list_constructible_polymorphic_derived_1>);
static_assert(not is_list_constructible_v<unit_test_is_list_constructible_polymorphic_virtual_derived_final, unit_test_is_list_constructible_polymorphic_derived_1>);
static_assert(is_list_constructible_v<unit_test_is_list_constructible_polymorphic_base &, unit_test_is_list_constructible_polymorphic_virtual_derived_1 &>);
static_assert(is_list_constructible_v<unit_test_is_list_constructible_polymorphic_base &, unit_test_is_list_constructible_polymorphic_virtual_derived_2 &>);
static_assert(is_list_constructible_v<unit_test_is_list_constructible_polymorphic_base &, unit_test_is_list_constructible_polymorphic_virtual_derived_final &>);
static_assert(not is_list_constructible_v<unit_test_is_list_constructible_polymorphic_virtual_derived_1 &, unit_test_is_list_constructible_polymorphic_base &>);
...
static_assert(not is_assignable_v<unit_test_is_assignable_polymorphic_derived_2 &, unit_test_is_assignable_polymorphic_base &>);
static_assert(not is_assignable_v<unit_test_is_assignable_polymorphic_derived_3 &, unit_test_is_assignable_polymorphic_base &>);
static_assert(is_assignable_v<unit_test_is_assignable_polymorphic_base, unit_test_is_assignable_polymorphic_virtual_derived_1>);
static_assert(is_assignable_v<unit_test_is_assignable_polymorphic_base, unit_test_is_assignable_polymorphic_virtual_derived_2>);
static_assert(is_assignable_v<unit_test_is_assignable_polymorphic_base, unit_test_is_assignable_polymorphic_virtual_derived_final>);
static_assert(not is_assignable_v<unit_test_is_assignable_polymorphic_virtual_derived_1, unit_test_is_assignable_polymorphic_base>);
static_assert(not is_assignable_v<unit_test_is_assignable_polymorphic_virtual_derived_2, unit_test_is_assignable_polymorphic_base>);
static_assert(not is_assignable_v<unit_test_is_assignable_polymorphic_virtual_derived_final, unit_test_is_assignable_polymorphic_base>);
static_assert(not is_assignable_v<unit_test_is_assignable_polymorphic_virtual_derived_1, unit_test_is_assignable_polymorphic_derived_1>);
static_assert(not is_assignable_v<unit_test_is_assignable_polymorphic_virtual_derived_2, unit_test_is_assignable_polymorphic_derived_1>);
static_assert(not is_assignable_v<unit_test_is_assignable_polymorphic_virtual_derived_final, unit_test_is_assignable_polymorphic_derived_1>);
static_assert(is_assignable_v<unit_test_is_assignable_polymorphic_base &, unit_test_is_assignable_polymorphic_virtual_derived_1 &>);
static_assert(is_assignable_v<unit_test_is_assignable_polymorphic_base &, unit_test_is_assignable_polymorphic_virtual_derived_2 &>);
static_assert(is_assignable_v<unit_test_is_assignable_polymorphic_base &, unit_test_is_assignable_polymorphic_virtual_derived_final &>);
static_assert(not is_assignable_v<unit_test_is_assignable_polymorphic_virtual_derived_1 &, unit_test_is_assignable_polymorphic_base &>);
...
static_assert(not is_assignable_v<unit_test_is_assignable_polymorphic_virtual_derived_2 &, unit_test_is_assignable_polymorphic_derived_1 &>);
static_assert(not is_assignable_v<unit_test_is_assignable_polymorphic_virtual_derived_final &, unit_test_is_assignable_polymorphic_derived_1 &>);
static_assert(not is_assignable_v<unit_test_is_assignable_polymorphic_base *, unit_test_is_assignable_polymorphic_virtual_derived_1 *>);
static_assert(not is_assignable_v<unit_test_is_assignable_polymorphic_base *, unit_test_is_assignable_polymorphic_virtual_derived_2 *>);
static_assert(not is_assignable_v<unit_test_is_assignable_polymorphic_base *, unit_test_is_assignable_polymorphic_virtual_derived_final *>);
static_assert(not is_assignable_v<unit_test_is_assignable_polymorphic_virtual_derived_1 *, unit_test_is_assignable_polymorphic_base *>);
static_assert(not is_assignable_v<unit_test_is_assignable_polymorphic_virtual_derived_2 *, unit_test_is_assignable_polymorphic_base *>);
static_assert(not is_assignable_v<unit_test_is_assignable_polymorphic_virtual_derived_final *, unit_test_is_assignable_polymorphic_base *>);
static_assert(not is_assignable_v<unit_test_is_assignable_polymorphic_virtual_derived_1 *, unit_test_is_assignable_polymorphic_derived_1 *>);
...
struct unit_test_is_convertible_polymorphic_virtual_derived_final final : unit_test_is_convertible_polymorphic_virtual_derived_1, unit_test_is_convertible_polymorphic_virtual_derived_2 {
    int d;
};
...
static_assert(is_convertible_v<D, unit_test_is_convertible>);
static_assert(not is_convertible_v<unit_test_is_convertible_base, unit_test_is_convertible_derived>);
static_assert(is_convertible_v<unit_test_is_convertible_derived, unit_test_is_convertible_base>);
static_assert(not is_convertible_v<unit_test_is_convertible_base *, unit_test_is_convertible_derived *>);
static_assert(is_convertible_v<unit_test_is_convertible_derived *, unit_test_is_convertible_base *>);
static_assert(not is_convertible_v<unit_test_is_convertible_base *, const unit_test_is_convertible_derived *>);
static_assert(is_convertible_v<unit_test_is_convertible_derived *, const unit_test_is_convertible_base *>);
static_assert(not is_convertible_v<unit_test_is_convertible_base *, unit_test_is_convertible_derived *const>);
static_assert(is_convertible_v<unit_test_is_convertible_derived *, unit_test_is_convertible_base *const>);
static_assert(not is_convertible_v<unit_test_is_convertible_base *, const unit_test_is_convertible_derived *const>);
static_assert(is_convertible_v<unit_test_is_convertible_derived *, const unit_test_is_convertible_base *const>);
static_assert(not is_convertible_v<const unit_test_is_convertible_base *, unit_test_is_convertible_derived *>);
static_assert(not is_convertible_v<const unit_test_is_convertible_derived *, unit_test_is_convertible_base *>);
static_assert(not is_convertible_v<const unit_test_is_convertible_base *, const unit_test_is_convertible_derived *>);
static_assert(is_convertible_v<const unit_test_is_convertible_derived *, const unit_test_is_convertible_base *>);
static_assert(not is_convertible_v<const unit_test_is_convertible_base *, unit_test_is_convertible_derived *const>);
static_assert(not is_convertible_v<const unit_test_is_convertible_derived *, unit_test_is_convertible_base *const>);
static_assert(not is_convertible_v<const unit_test_is_convertible_base *, const unit_test_is_convertible_derived *const>);
static_assert(is_convertible_v<const unit_test_is_convertible_derived *, const unit_test_is_convertible_base *const>);
static_assert(not is_convertible_v<unit_test_is_convertible_base *const, unit_test_is_convertible_derived *>);
static_assert(is_convertible_v<unit_test_is_convertible_derived *const, unit_test_is_convertible_base *>);
static_assert(not is_convertible_v<unit_test_is_convertible_base *const, const unit_test_is_convertible_derived *>);
static_assert(is_convertible_v<unit_test_is_convertible_derived *const, const unit_test_is_convertible_base *>);
static_assert(not is_convertible_v<unit_test_is_convertible_base *const, unit_test_is_convertible_derived *const>);
static_assert(is_convertible_v<unit_test_is_convertible_derived *const, unit_test_is_convertible_base *const>);
static_assert(not is_convertible_v<unit_test_is_convertible_base *const, const unit_test_is_convertible_derived *const>);
static_assert(is_convertible_v<unit_test_is_convertible_derived *const, const unit_test_is_convertible_base *const>);
static_assert(not is_convertible_v<const unit_test_is_convertible_base *const, unit_test_is_convertible_derived *>);
static_assert(not is_convertible_v<const unit_test_is_convertible_derived *const, unit_test_is_convertible_base *>);
static_assert(not is_convertible_v<const unit_test_is_convertible_base *const, const unit_test_is_convertible_derived *>);
static_assert(is_convertible_v<const unit_test_is_convertible_derived *const, const unit_test_is_convertible_base *>);
static_assert(not is_convertible_v<const unit_test_is_convertible_base *const, unit_test_is_convertible_derived *const>);
static_assert(not is_convertible_v<const unit_test_is_convertible_derived *const, unit_test_is_convertible_base *const>);
static_assert(not is_convertible_v<const unit_test_is_convertible_base *const, const unit_test_is_convertible_derived *const>);
static_assert(is_convertible_v<const unit_test_is_convertible_derived *const, const unit_test_is_convertible_base *const>);
static_assert(not is_convertible_v<unit_test_is_convertible_base &, unit_test_is_convertible_derived &>);
static_assert(not is_convertible_v<unit_test_is_convertible_base &, unit_test_is_convertible_derived &&>);
static_assert(is_convertible_v<unit_test_is_convertible_derived &, unit_test_is_convertible_base &>);
static_assert(not is_convertible_v<unit_test_is_convertible_derived &, unit_test_is_convertible_base &&>);
static_assert(not is_convertible_v<unit_test_is_convertible_base &, const unit_test_is_convertible_derived &>);
static_assert(not is_convertible_v<unit_test_is_convertible_base &, const unit_test_is_convertible_derived &&>);
static_assert(is_convertible_v<unit_test_is_convertible_derived &, const unit_test_is_convertible_base &>);
static_assert(not is_convertible_v<unit_test_is_convertible_derived &, const unit_test_is_convertible_base &&>);
static_assert(not is_convertible_v<const unit_test_is_convertible_base &, unit_test_is_convertible_derived &>);
static_assert(not is_convertible_v<const unit_test_is_convertible_base &, unit_test_is_convertible_derived &&>);
static_assert(not is_convertible_v<const unit_test_is_convertible_derived &, unit_test_is_convertible_base &>);
static_assert(not is_convertible_v<const unit_test_is_convertible_derived &, unit_test_is_convertible_base &&>);
...
static_assert(is_convertible_v<const unit_test_is_convertible_derived &&, const unit_test_is_convertible_base &>);
static_assert(is_convertible_v<const unit_test_is_convertible_derived &&, const unit_test_is_convertible_base &&>);
static_assert(not is_convertible_v<unit_test_is_convertible_polymorphic_base, unit_test_is_convertible_polymorphic_derived_1>);
static_assert(not is_convertible_v<unit_test_is_convertible_polymorphic_base, unit_test_is_convertible_polymorphic_derived_2>);
static_assert(not is_convertible_v<unit_test_is_convertible_polymorphic_base, unit_test_is_convertible_polymorphic_derived_3>);
static_assert(is_convertible_v<unit_test_is_convertible_polymorphic_derived_1, unit_test_is_convertible_polymorphic_base>);
static_assert(is_convertible_v<unit_test_is_convertible_polymorphic_derived_2, unit_test_is_convertible_polymorphic_base>);
static_assert(not is_convertible_v<unit_test_is_convertible_polymorphic_derived_3, unit_test_is_convertible_polymorphic_base>);
static_assert(not is_convertible_v<unit_test_is_convertible_polymorphic_base *, unit_test_is_convertible_polymorphic_derived_1 *>);
static_assert(not is_convertible_v<unit_test_is_convertible_polymorphic_base *, unit_test_is_convertible_polymorphic_derived_2 *>);
static_assert(not is_convertible_v<unit_test_is_convertible_polymorphic_base *, unit_test_is_convertible_polymorphic_derived_3 *>);
static_assert(is_convertible_v<unit_test_is_convertible_polymorphic_derived_1 *, unit_test_is_convertible_polymorphic_base *>);
...
static_assert(is_convertible_v<unit_test_is_convertible_polymorphic_derived_2 &, unit_test_is_convertible_polymorphic_base &>);
static_assert(not is_convertible_v<unit_test_is_convertible_polymorphic_derived_3 &, unit_test_is_convertible_polymorphic_base &>);
static_assert(not is_convertible_v<unit_test_is_convertible_polymorphic_base, unit_test_is_convertible_polymorphic_virtual_derived_1>);
static_assert(not is_convertible_v<unit_test_is_convertible_polymorphic_base, unit_test_is_convertible_polymorphic_virtual_derived_2>);
static_assert(not is_convertible_v<unit_test_is_convertible_polymorphic_base, unit_test_is_convertible_polymorphic_virtual_derived_final>);
static_assert(is_convertible_v<unit_test_is_convertible_polymorphic_virtual_derived_1, unit_test_is_convertible_polymorphic_base>);
static_assert(is_convertible_v<unit_test_is_convertible_polymorphic_virtual_derived_2, unit_test_is_convertible_polymorphic_base>);
static_assert(is_convertible_v<unit_test_is_convertible_polymorphic_virtual_derived_final, unit_test_is_convertible_polymorphic_base>);
static_assert(is_convertible_v<unit_test_is_convertible_polymorphic_virtual_derived_1, unit_test_is_convertible_polymorphic_derived_1>);
static_assert(is_convertible_v<unit_test_is_convertible_polymorphic_virtual_derived_2, unit_test_is_convertible_polymorphic_derived_1>);
static_assert(is_convertible_v<unit_test_is_convertible_polymorphic_virtual_derived_final, unit_test_is_convertible_polymorphic_derived_1>);
static_assert(not is_convertible_v<unit_test_is_convertible_polymorphic_base &, unit_test_is_convertible_polymorphic_virtual_derived_1 &>);
static_assert(not is_convertible_v<unit_test_is_convertible_polymorphic_base &, unit_test_is_convertible_polymorphic_virtual_derived_2 &>);
static_assert(not is_convertible_v<unit_test_is_convertible_polymorphic_base &, unit_test_is_convertible_polymorphic_virtual_derived_final &>);
static_assert(is_convertible_v<unit_test_is_convertible_polymorphic_virtual_derived_1 &, unit_test_is_convertible_polymorphic_base &>);
...
static_assert(is_convertible_v<unit_test_is_convertible_polymorphic_virtual_derived_2 *, unit_test_is_convertible_polymorphic_derived_1 *>);
static_assert(is_convertible_v<unit_test_is_convertible_polymorphic_virtual_derived_final *, unit_test_is_convertible_polymorphic_derived_1 *>);
static_assert(is_convertible_v<unit_test_is_convertible, int>);
static_assert(not is_convertible_v<unit_test_is_convertible, char>);
static_assert(not is_convertible_v<unit_test_is_convertible, double>);
static_assert(not is_convertible_v<unit_test_is_convertible, void *>);
static_assert(not is_convertible_v<unit_test_is_convertible, long>);
static_assert(not is_convertible_v<unit_test_is_convertible, int *>);
static_assert(is_convertible_v<unsigned short, unit_test_is_convertible>);
static_assert(is_convertible_v<unsigned short &, unit_test_is_convertible>);
static_assert(not is_convertible_v<unsigned, unit_test_is_convertible>);
static_assert(not is_convertible_v<unsigned long, unit_test_is_convertible>);
static_assert(not is_convertible_v<unsigned long, unit_test_is_convertible &>);
static_assert(not is_convertible_v<unsigned long, const unit_test_is_convertible &>);
static_assert(not is_convertible_v<float, unit_test_is_convertible>);
static_assert(not is_convertible_v<double, unit_test_is_convertible>);
static_assert(not is_convertible_v<long double, const unit_test_is_convertible &>);
static_assert(not is_convertible_v<int **, unit_test_is_convertible>);        // prefer to operator int **&()
static_assert(not is_convertible_v<int **&&, unit_test_is_convertible>);      // still prefer to operator int **&()
__DATA_STRUCTURE_END
...
__DATA_STRUCTURE_START(unit test for ds::is_static_castable)
struct unit_test_is_static_castable_base {
    int a;
};
struct unit_test_is_static_castable_derived : unit_test_is_static_castable_base {
    int b;
};
struct unit_test_is_static_castable_polymorphic_base {
    int a;
    virtual ~unit_test_is_static_castable_polymorphic_base();
};
struct unit_test_is_static_castable_polymorphic_derived_1 : unit_test_is_static_castable_polymorphic_base {
    int b;
    virtual ~unit_test_is_static_castable_polymorphic_derived_1() override;
};
struct unit_test_is_static_castable_polymorphic_derived_2 : unit_test_is_static_castable_polymorphic_base {
    int c;
};
struct unit_test_is_static_castable_polymorphic_derived_3 : unit_test_is_static_castable_polymorphic_derived_1, unit_test_is_static_castable_polymorphic_derived_2 {
    int d;
};
struct unit_test_is_static_castable_polymorphic_virtual_derived_1 : virtual unit_test_is_static_castable_polymorphic_derived_1 {
    int b;
};
struct unit_test_is_static_castable_polymorphic_virtual_derived_2 : virtual unit_test_is_static_castable_polymorphic_derived_1 {
    int c;
};
struct unit_test_is_static_castable_polymorphic_virtual_derived_final : unit_test_is_static_castable_polymorphic_virtual_derived_1, unit_test_is_static_castable_polymorphic_virtual_derived_2 {
    int d;
};
struct unit_test_is_static_castable {
    unit_test_is_static_castable() = default;
    unit_test_is_static_castable(int);
    explicit unit_test_is_static_castable(char);
    unit_test_is_static_castable(double) = delete;
    explicit unit_test_is_static_castable(void *) = delete;
    unit_test_is_static_castable(int, char);
    explicit unit_test_is_static_castable(long, long);
    unit_test_is_static_castable(initializer_list<int *>);
    explicit unit_test_is_static_castable(initializer_list<char *>);
    unit_test_is_static_castable(initializer_list<double *>, int, char, long);
    template <typename T, typename U, typename V>
    unit_test_is_static_castable(T, U &&, V **);
    unit_test_is_static_castable(void *, void *, void **) = delete;
    operator unsigned short &();
    operator unsigned &() = delete;
    operator const unsigned long &() const &;
    explicit operator float &();
...
static_assert(is_static_castable_v<int, int>);
static_assert(not is_static_castable_v<int, int &>);
static_assert(is_static_castable_v<int, int &&>);
static_assert(is_static_castable_v<int, const int>);
static_assert(is_static_castable_v<int, volatile int>);
static_assert(is_static_castable_v<int, const volatile int>);
static_assert(is_static_castable_v<int, const int &>);
static_assert(not is_static_castable_v<int, volatile int &>);
static_assert(not is_static_castable_v<int, const volatile int &>);
static_assert(is_static_castable_v<int, const int &&>);
static_assert(is_static_castable_v<int, volatile int &&>);
static_assert(is_static_castable_v<int, const volatile int &&>);
static_assert(not is_static_castable_v<int, int *>);
static_assert(not is_static_castable_v<int &, int *>);
static_assert(not is_static_castable_v<int &&, int *>);
static_assert(not is_static_castable_v<int, void *>);
static_assert(not is_static_castable_v<int, char *>);
static_assert(is_static_castable_v<int &, int>);
static_assert(is_static_castable_v<int &, int &>);
static_assert(is_static_castable_v<int &, int &&>);
static_assert(is_static_castable_v<int &, const int>);
...
static_assert(is_static_castable_v<int &&, volatile int &&>);
static_assert(is_static_castable_v<int &&, const volatile int &&>);
static_assert(is_static_castable_v<const int, int>);
static_assert(not is_static_castable_v<const int, int &>);
static_assert(not is_static_castable_v<const int, int &&>);
static_assert(is_static_castable_v<const int, const int>);
static_assert(is_static_castable_v<const int, volatile int>);
static_assert(is_static_castable_v<const int, const volatile int>);
static_assert(is_static_castable_v<const int, const int &>);
static_assert(not is_static_castable_v<const int, volatile int &>);
static_assert(not is_static_castable_v<const int, const volatile int &>);
static_assert(is_static_castable_v<const int, const int &&>);
static_assert(not is_static_castable_v<const int, volatile int &&>);
static_assert(is_static_castable_v<const int, const volatile int &&>);
static_assert(is_static_castable_v<volatile int, int>);
static_assert(not is_static_castable_v<volatile int, int &>);
static_assert(not is_static_castable_v<volatile int, int &&>);
static_assert(is_static_castable_v<volatile int, const int>);
static_assert(is_static_castable_v<volatile int, volatile int>);
static_assert(is_static_castable_v<volatile int, const volatile int>);
static_assert(not is_static_castable_v<volatile int, const int &>);
static_assert(not is_static_castable_v<volatile int, volatile int &>);
static_assert(not is_static_castable_v<volatile int, const volatile int &>);
static_assert(not is_static_castable_v<volatile int, const int &&>);
static_assert(is_static_castable_v<volatile int, volatile int &&>);
static_assert(is_static_castable_v<volatile int, const volatile int &&>);
static_assert(is_static_castable_v<const volatile int, int>);
static_assert(not is_static_castable_v<const volatile int, int &>);
static_assert(not is_static_castable_v<const volatile int, int &&>);
static_assert(is_static_castable_v<const volatile int, const int>);
static_assert(is_static_castable_v<const volatile int, volatile int>);
static_assert(is_static_castable_v<const volatile int, const volatile int>);
static_assert(not is_static_castable_v<const volatile int, const int &>);
static_assert(not is_static_castable_v<const volatile int, volatile int &>);
static_assert(not is_static_castable_v<const volatile int, const volatile int &>);
static_assert(not is_static_castable_v<const volatile int, const int &&>);
static_assert(not is_static_castable_v<const volatile int, volatile int &&>);
static_assert(is_static_castable_v<const volatile int, const volatile int &&>);
static_assert(is_static_castable_v<const int &, int>);
...
static_assert(not is_static_castable_v<const volatile int &&, volatile int &&>);
static_assert(is_static_castable_v<const volatile int &&, const volatile int &&>);
static_assert(is_static_castable_v<int, bool>);
static_assert(is_static_castable_v<int, short>);
static_assert(is_static_castable_v<int, unsigned short>);
static_assert(is_static_castable_v<int, char>);
static_assert(is_static_castable_v<int, unsigned char>);
static_assert(is_static_castable_v<int, signed char>);
static_assert(is_static_castable_v<int, unsigned>);
static_assert(is_static_castable_v<int, long>);
static_assert(is_static_castable_v<int, unsigned long>);
static_assert(is_static_castable_v<int, const unsigned>);
static_assert(is_static_castable_v<int, const long>);
static_assert(is_static_castable_v<int, const unsigned long>);
static_assert(is_static_castable_v<int, char8_t>);
static_assert(is_static_castable_v<int, char16_t>);
static_assert(is_static_castable_v<int, char32_t>);
static_assert(is_static_castable_v<int, wchar_t>);
static_assert(is_static_castable_v<int, float>);
static_assert(is_static_castable_v<double, float>);
static_assert(is_static_castable_v<double, int>);
static_assert(is_static_castable_v<double, unsigned>);
static_assert(is_static_castable_v<double, long double>);
static_assert(is_static_castable_v<double, const int>);
static_assert(is_static_castable_v<double, const unsigned>);
static_assert(not is_static_castable_v<int *, int []>);
static_assert(not is_static_castable_v<const int *, int []>);
static_assert(not is_static_castable_v<int *const, int []>);
static_assert(not is_static_castable_v<const int *const, int []>);
static_assert(not is_static_castable_v<int *, int [42]>);
static_assert(not is_static_castable_v<const int *, int [42]>);
static_assert(not is_static_castable_v<int *const, int [42]>);
static_assert(not is_static_castable_v<const int *const, int [42]>);
static_assert(not is_static_castable_v<int [], initializer_list<int>>);
static_assert(not is_static_castable_v<int [42], initializer_list<int>>);
static_assert(not is_static_castable_v<int *, initializer_list<int>>);
static_assert(not is_static_castable_v<int (&)[], int []>);
static_assert(not is_static_castable_v<int (&&)[], int []>);
static_assert(not is_static_castable_v<int (&)[42], int [42]>);
static_assert(not is_static_castable_v<int (&&)[42], int [42]>);
static_assert(not is_static_castable_v<int (&)[], initializer_list<int>>);
static_assert(not is_static_castable_v<int (&)[42], initializer_list<int>>);
static_assert(not is_static_castable_v<int *, int (&)[]>);
...
static_assert(not is_static_castable_v<const int *const, int (&)[42]>);
static_assert(not is_static_castable_v<const int *const, int (&&)[42]>);
static_assert(not is_static_castable_v<void (*)(), void ()>);
static_assert(not is_static_castable_v<void (), void ()>);
static_assert(not is_static_castable_v<void (&)(), void ()>);
static_assert(not is_static_castable_v<void (&&)(), void ()>);
static_assert(is_static_castable_v<void (&)(), void (&&)()>);
static_assert(is_static_castable_v<void (&&)(), void (&)()>);
static_assert(not is_static_castable_v<void (*)(), void (&)()>);
static_assert(not is_static_castable_v<void (*)(), void (&&)()>);
static_assert(not is_static_castable_v<void (*const)(), void ()>);
static_assert(not is_static_castable_v<void (*const)(), void (&)()>);
static_assert(not is_static_castable_v<void (*const)(), void (&&)()>);
static_assert(is_static_castable_v<int *, void *>);
static_assert(is_static_castable_v<int *, void *const>);
static_assert(is_static_castable_v<int *, const void *>);
static_assert(is_static_castable_v<int *, const void *const >);
static_assert(is_static_castable_v<int *const, void *>);
static_assert(not is_static_castable_v<const int *, void *>);
static_assert(is_static_castable_v<int [], void *>);
static_assert(is_static_castable_v<int [], void *const>);
static_assert(is_static_castable_v<int [], const void *>);
static_assert(is_static_castable_v<int [], const void *const>);
static_assert(is_static_castable_v<int [42], void *>);
static_assert(is_static_castable_v<int [42], void *const>);
static_assert(is_static_castable_v<int [42], const void *>);
static_assert(is_static_castable_v<int [42], const void *const>);
static_assert(not is_static_castable_v<const int [], void *>);
static_assert(is_static_castable_v<const int [], const void *>);
static_assert(is_static_castable_v<const int [42], const void *>);
static_assert(is_static_castable_v<int (&)[], void *>);
static_assert(is_static_castable_v<int (&)[], void *const>);
static_assert(is_static_castable_v<int (&)[], const void *>);
static_assert(is_static_castable_v<int (&)[], const void *const>);
...
static_assert(not is_static_castable_v<void (), void *>);
static_assert(not is_static_castable_v<void (*)(), void *>);
static_assert(not is_static_castable_v<void (A::*)(), void *>);
static_assert(is_static_castable_v<__int128_t, int>);
static_assert(is_static_castable_v<__uint128_t, int>);
static_assert(is_static_castable_v<__int128_t, unsigned>);
static_assert(is_static_castable_v<__uint128_t, unsigned>);
static_assert(is_static_castable_v<__int128_t, double>);
static_assert(is_static_castable_v<__uint128_t, double>);
static_assert(is_static_castable_v<int, C>);
static_assert(is_static_castable_v<int, D>);
static_assert(is_static_castable_v<C, int>);
static_assert(is_static_castable_v<D, int>);
static_assert(is_static_castable_v<D, short>);
static_assert(is_static_castable_v<D, bool>);
static_assert(is_static_castable_v<D, unsigned>);
static_assert(is_static_castable_v<D, unit_test_is_static_castable>);
static_assert(not is_static_castable_v<unit_test_is_static_castable_base, unit_test_is_static_castable_derived>);
static_assert(is_static_castable_v<unit_test_is_static_castable_derived, unit_test_is_static_castable_base>);
static_assert(is_static_castable_v<unit_test_is_static_castable_base *, unit_test_is_static_castable_derived *>);
static_assert(is_static_castable_v<unit_test_is_static_castable_derived *, unit_test_is_static_castable_base *>);
static_assert(is_static_castable_v<unit_test_is_static_castable_base *, const unit_test_is_static_castable_derived *>);
static_assert(is_static_castable_v<unit_test_is_static_castable_derived *, const unit_test_is_static_castable_base *>);
static_assert(is_static_castable_v<unit_test_is_static_castable_base *, unit_test_is_static_castable_derived *const>);
static_assert(is_static_castable_v<unit_test_is_static_castable_derived *, unit_test_is_static_castable_base *const>);
static_assert(is_static_castable_v<unit_test_is_static_castable_base *, const unit_test_is_static_castable_derived *const>);
static_assert(is_static_castable_v<unit_test_is_static_castable_derived *, const unit_test_is_static_castable_base *const>);
static_assert(not is_static_castable_v<const unit_test_is_static_castable_base *, unit_test_is_static_castable_derived *>);
static_assert(not is_static_castable_v<const unit_test_is_static_castable_derived *, unit_test_is_static_castable_base *>);
static_assert(is_static_castable_v<const unit_test_is_static_castable_base *, const unit_test_is_static_castable_derived *>);
static_assert(is_static_castable_v<const unit_test_is_static_castable_derived *, const unit_test_is_static_castable_base *>);
static_assert(not is_static_castable_v<const unit_test_is_static_castable_base *, unit_test_is_static_castable_derived *const>);
static_assert(not is_static_castable_v<const unit_test_is_static_castable_derived *, unit_test_is_static_castable_base *const>);
static_assert(is_static_castable_v<const unit_test_is_static_castable_base *, const unit_test_is_static_castable_derived *const>);
static_assert(is_static_castable_v<const unit_test_is_static_castable_derived *, const unit_test_is_static_castable_base *const>);
static_assert(is_static_castable_v<unit_test_is_static_castable_base *const, unit_test_is_static_castable_derived *>);
static_assert(is_static_castable_v<unit_test_is_static_castable_derived *const, unit_test_is_static_castable_base *>);
static_assert(is_static_castable_v<unit_test_is_static_castable_base *const, const unit_test_is_static_castable_derived *>);
static_assert(is_static_castable_v<unit_test_is_static_castable_derived *const, const unit_test_is_static_castable_base *>);
static_assert(is_static_castable_v<unit_test_is_static_castable_base *const, unit_test_is_static_castable_derived *const>);
static_assert(is_static_castable_v<unit_test_is_static_castable_derived *const, unit_test_is_static_castable_base *const>);
static_assert(is_static_castable_v<unit_test_is_static_castable_base *const, const unit_test_is_static_castable_derived *const>);
static_assert(is_static_castable_v<unit_test_is_static_castable_derived *const, const unit_test_is_static_castable_base *const>);
static_assert(not is_static_castable_v<const unit_test_is_static_castable_base *const, unit_test_is_static_castable_derived *>);
static_assert(not is_static_castable_v<const unit_test_is_static_castable_derived *const, unit_test_is_static_castable_base *>);
static_assert(is_static_castable_v<const unit_test_is_static_castable_base *const, const unit_test_is_static_castable_derived *>);
static_assert(is_static_castable_v<const unit_test_is_static_castable_derived *const, const unit_test_is_static_castable_base *>);
static_assert(not is_static_castable_v<const unit_test_is_static_castable_base *const, unit_test_is_static_castable_derived *const>);
static_assert(not is_static_castable_v<const unit_test_is_static_castable_derived *const, unit_test_is_static_castable_base *const>);
static_assert(is_static_castable_v<const unit_test_is_static_castable_base *const, const unit_test_is_static_castable_derived *const>);
static_assert(is_static_castable_v<const unit_test_is_static_castable_derived *const, const unit_test_is_static_castable_base *const>);
static_assert(is_static_castable_v<unit_test_is_static_castable_base &, unit_test_is_static_castable_derived &>);
static_assert(is_static_castable_v<unit_test_is_static_castable_base &, unit_test_is_static_castable_derived &&>);
static_assert(is_static_castable_v<unit_test_is_static_castable_derived &, unit_test_is_static_castable_base &>);
static_assert(is_static_castable_v<unit_test_is_static_castable_derived &, unit_test_is_static_castable_base &&>);
...
static_assert(not is_static_castable_v<unit_test_is_static_castable_base &&, unit_test_is_static_castable_derived &>);
static_assert(is_static_castable_v<unit_test_is_static_castable_base &&, unit_test_is_static_castable_derived &&>);
static_assert(not is_static_castable_v<unit_test_is_static_castable_derived &&, unit_test_is_static_castable_base &>);
static_assert(is_static_castable_v<unit_test_is_static_castable_derived &, unit_test_is_static_castable_base &&>);
static_assert(not is_static_castable_v<unit_test_is_static_castable_base &&, const unit_test_is_static_castable_derived &>);
static_assert(is_static_castable_v<unit_test_is_static_castable_base &&, const unit_test_is_static_castable_derived &&>);
static_assert(is_static_castable_v<unit_test_is_static_castable_derived &&, const unit_test_is_static_castable_base &>);
static_assert(is_static_castable_v<unit_test_is_static_castable_derived &&, const unit_test_is_static_castable_base &&>);
static_assert(not is_static_castable_v<const unit_test_is_static_castable_base &&, unit_test_is_static_castable_derived &>);
...
static_assert(is_static_castable_v<const unit_test_is_static_castable_derived &&, const unit_test_is_static_castable_base &>);
static_assert(is_static_castable_v<const unit_test_is_static_castable_derived &&, const unit_test_is_static_castable_base &&>);
static_assert(not is_static_castable_v<unit_test_is_static_castable_polymorphic_base, unit_test_is_static_castable_polymorphic_derived_1>);
static_assert(not is_static_castable_v<unit_test_is_static_castable_polymorphic_base, unit_test_is_static_castable_polymorphic_derived_2>);
static_assert(not is_static_castable_v<unit_test_is_static_castable_polymorphic_base, unit_test_is_static_castable_polymorphic_derived_3>);
static_assert(is_static_castable_v<unit_test_is_static_castable_polymorphic_derived_1, unit_test_is_static_castable_polymorphic_base>);
static_assert(is_static_castable_v<unit_test_is_static_castable_polymorphic_derived_2, unit_test_is_static_castable_polymorphic_base>);
static_assert(not is_static_castable_v<unit_test_is_static_castable_polymorphic_derived_3, unit_test_is_static_castable_polymorphic_base>);
static_assert(is_static_castable_v<unit_test_is_static_castable_polymorphic_base *, unit_test_is_static_castable_polymorphic_derived_1 *>);
static_assert(is_static_castable_v<unit_test_is_static_castable_polymorphic_base *, unit_test_is_static_castable_polymorphic_derived_2 *>);
static_assert(not is_static_castable_v<unit_test_is_static_castable_polymorphic_base *, unit_test_is_static_castable_polymorphic_derived_3 *>);
static_assert(is_static_castable_v<unit_test_is_static_castable_polymorphic_derived_1 *, unit_test_is_static_castable_polymorphic_base *>);
static_assert(is_static_castable_v<unit_test_is_static_castable_polymorphic_derived_2 *, unit_test_is_static_castable_polymorphic_base *>);
static_assert(not is_static_castable_v<unit_test_is_static_castable_polymorphic_derived_3 *, unit_test_is_static_castable_polymorphic_base *>);
...
static_assert(is_static_castable_v<unit_test_is_static_castable_polymorphic_derived_2 &, unit_test_is_static_castable_polymorphic_base &>);
static_assert(not is_static_castable_v<unit_test_is_static_castable_polymorphic_derived_3 &, unit_test_is_static_castable_polymorphic_base &>);
static_assert(not is_static_castable_v<unit_test_is_static_castable_polymorphic_base, unit_test_is_static_castable_polymorphic_virtual_derived_1>);
static_assert(not is_static_castable_v<unit_test_is_static_castable_polymorphic_base, unit_test_is_static_castable_polymorphic_virtual_derived_2>);
static_assert(not is_static_castable_v<unit_test_is_static_castable_polymorphic_base, unit_test_is_static_castable_polymorphic_virtual_derived_final>);
static_assert(is_static_castable_v<unit_test_is_static_castable_polymorphic_virtual_derived_1, unit_test_is_static_castable_polymorphic_base>);
static_assert(is_static_castable_v<unit_test_is_static_castable_polymorphic_virtual_derived_2, unit_test_is_static_castable_polymorphic_base>);
static_assert(is_static_castable_v<unit_test_is_static_castable_polymorphic_virtual_derived_final, unit_test_is_static_castable_polymorphic_base>);
static_assert(is_static_castable_v<unit_test_is_static_castable_polymorphic_virtual_derived_1, unit_test_is_static_castable_polymorphic_derived_1>);
static_assert(is_static_castable_v<unit_test_is_static_castable_polymorphic_virtual_derived_2, unit_test_is_static_castable_polymorphic_derived_1>);
static_assert(is_static_castable_v<unit_test_is_static_castable_polymorphic_virtual_derived_final, unit_test_is_static_castable_polymorphic_derived_1>);
static_assert(not is_static_castable_v<unit_test_is_static_castable_polymorphic_base &, unit_test_is_static_castable_polymorphic_virtual_derived_1 &>);
static_assert(not is_static_castable_v<unit_test_is_static_castable_polymorphic_base &, unit_test_is_static_castable_polymorphic_virtual_derived_2 &>);
static_assert(not is_static_castable_v<unit_test_is_static_castable_polymorphic_base &, unit_test_is_static_castable_polymorphic_virtual_derived_final &>);
static_assert(is_static_castable_v<unit_test_is_static_castable_polymorphic_virtual_derived_1 &, unit_test_is_static_castable_polymorphic_base &>);
...
static_assert(is_static_castable_v<unit_test_is_static_castable_polymorphic_virtual_derived_2 *, unit_test_is_static_castable_polymorphic_derived_1 *>);
static_assert(is_static_castable_v<unit_test_is_static_castable_polymorphic_virtual_derived_final *, unit_test_is_static_castable_polymorphic_derived_1 *>);
static_assert(is_static_castable_v<unit_test_is_static_castable, int>);
static_assert(not is_static_castable_v<unit_test_is_static_castable, char>);
static_assert(not is_static_castable_v<unit_test_is_static_castable, double>);
static_assert(not is_static_castable_v<unit_test_is_static_castable, void *>);
static_assert(not is_static_castable_v<unit_test_is_static_castable, long>);
static_assert(not is_static_castable_v<unit_test_is_static_castable, int *>);
static_assert(is_static_castable_v<unsigned short, unit_test_is_static_castable>);
static_assert(is_static_castable_v<unsigned short &, unit_test_is_static_castable>);
static_assert(not is_static_castable_v<unsigned, unit_test_is_static_castable>);
static_assert(not is_static_castable_v<unsigned long, unit_test_is_static_castable>);
static_assert(not is_static_castable_v<unsigned long, unit_test_is_static_castable &>);
static_assert(not is_static_castable_v<unsigned long, const unit_test_is_static_castable &>);
static_assert(not is_static_castable_v<float, unit_test_is_static_castable>);
static_assert(not is_static_castable_v<double, unit_test_is_static_castable>);
static_assert(not is_static_castable_v<long double, const unit_test_is_static_castable &>);
static_assert(not is_static_castable_v<int **, unit_test_is_static_castable>);        // prefer to operator int **&()
static_assert(not is_static_castable_v<int **&&, unit_test_is_static_castable>);      // still prefer to operator int **&()
__DATA_STRUCTURE_END

__DATA_STRUCTURE_START(unit test for ds::is_dynamic_castable)
struct unit_test_is_dynamic_castable_base {
    int a;
};
struct unit_test_is_dynamic_castable_derived : unit_test_is_dynamic_castable_base {
    int b;
};
struct unit_test_is_dynamic_castable_polymorphic_base {
    int a;
    virtual ~unit_test_is_dynamic_castable_polymorphic_base();
};
struct unit_test_is_dynamic_castable_polymorphic_derived_1 : unit_test_is_dynamic_castable_polymorphic_base {
    int b;
    virtual ~unit_test_is_dynamic_castable_polymorphic_derived_1() override;
};
struct unit_test_is_dynamic_castable_polymorphic_derived_2 : unit_test_is_dynamic_castable_polymorphic_base {
    int c;
};
struct unit_test_is_dynamic_castable_polymorphic_derived_3 : unit_test_is_dynamic_castable_polymorphic_derived_1, unit_test_is_dynamic_castable_polymorphic_derived_2 {
    int d;
};
struct unit_test_is_dynamic_castable_polymorphic_virtual_derived_1 : virtual unit_test_is_dynamic_castable_polymorphic_derived_1 {
    int b;
};
struct unit_test_is_dynamic_castable_polymorphic_virtual_derived_2 : virtual unit_test_is_dynamic_castable_polymorphic_derived_1 {
    int c;
};
struct unit_test_is_dynamic_castable_polymorphic_virtual_derived_final : unit_test_is_dynamic_castable_polymorphic_virtual_derived_1, unit_test_is_dynamic_castable_polymorphic_virtual_derived_2 {
    int d;
};
struct unit_test_is_dynamic_castable {
    unit_test_is_dynamic_castable() = default;
    unit_test_is_dynamic_castable(int);
    explicit unit_test_is_dynamic_castable(char);
    unit_test_is_dynamic_castable(double) = delete;
    explicit unit_test_is_dynamic_castable(void *) = delete;
    unit_test_is_dynamic_castable(int, char);
    explicit unit_test_is_dynamic_castable(long, long);
    unit_test_is_dynamic_castable(initializer_list<int *>);
    explicit unit_test_is_dynamic_castable(initializer_list<char *>);
    unit_test_is_dynamic_castable(initializer_list<double *>, int, char, long);
    template <typename T, typename U, typename V>
    unit_test_is_dynamic_castable(T, U &&, V **);
    unit_test_is_dynamic_castable(void *, void *, void **) = delete;
    operator unsigned short &();
    operator unsigned &() = delete;
    operator const unsigned long &() const &;
    explicit operator float &();
...
static_assert(not is_dynamic_castable_v<int, int>);
static_assert(not is_dynamic_castable_v<int, int &>);
static_assert(not is_dynamic_castable_v<int, int &&>);
static_assert(not is_dynamic_castable_v<int, const int>);
static_assert(not is_dynamic_castable_v<int, volatile int>);
static_assert(not is_dynamic_castable_v<int, const volatile int>);
static_assert(not is_dynamic_castable_v<int, const int &>);
static_assert(not is_dynamic_castable_v<int, volatile int &>);
static_assert(not is_dynamic_castable_v<int, const volatile int &>);
static_assert(not is_dynamic_castable_v<int, const int &&>);
...
static_assert(not is_dynamic_castable_v<int &, int *>);
static_assert(not is_dynamic_castable_v<int &&, int *>);
static_assert(not is_dynamic_castable_v<int, void *>);
static_assert(not is_dynamic_castable_v<int, char *>);
static_assert(not is_dynamic_castable_v<int &, int>);
static_assert(not is_dynamic_castable_v<int &, int &>);
static_assert(not is_dynamic_castable_v<int &, int &&>);
static_assert(not is_dynamic_castable_v<int &, const int>);
...
static_assert(not is_dynamic_castable_v<int &&, volatile int &&>);
static_assert(not is_dynamic_castable_v<int &&, const volatile int &&>);
static_assert(not is_dynamic_castable_v<const int, int>);
static_assert(not is_dynamic_castable_v<const int, int &>);
static_assert(not is_dynamic_castable_v<const int, int &&>);
static_assert(not is_dynamic_castable_v<const int, const int>);
static_assert(not is_dynamic_castable_v<const int, volatile int>);
static_assert(not is_dynamic_castable_v<const int, const volatile int>);
static_assert(not is_dynamic_castable_v<const int, const int &>);
static_assert(not is_dynamic_castable_v<const int, volatile int &>);
static_assert(not is_dynamic_castable_v<const int, const volatile int &>);
static_assert(not is_dynamic_castable_v<const int, const int &&>);
static_assert(not is_dynamic_castable_v<const int, volatile int &&>);
static_assert(not is_dynamic_castable_v<const int, const volatile int &&>);
static_assert(not is_dynamic_castable_v<volatile int, int>);
static_assert(not is_dynamic_castable_v<volatile int, int &>);
static_assert(not is_dynamic_castable_v<volatile int, int &&>);
static_assert(not is_dynamic_castable_v<volatile int, const int>);
static_assert(not is_dynamic_castable_v<volatile int, volatile int>);
static_assert(not is_dynamic_castable_v<volatile int, const volatile int>);
static_assert(not is_dynamic_castable_v<volatile int, const int &>);
static_assert(not is_dynamic_castable_v<volatile int, volatile int &>);
static_assert(not is_dynamic_castable_v<volatile int, const volatile int &>);
static_assert(not is_dynamic_castable_v<volatile int, const int &&>);
static_assert(not is_dynamic_castable_v<volatile int, volatile int &&>);
static_assert(not is_dynamic_castable_v<volatile int, const volatile int &&>);
static_assert(not is_dynamic_castable_v<const volatile int, int>);
static_assert(not is_dynamic_castable_v<const volatile int, int &>);
static_assert(not is_dynamic_castable_v<const volatile int, int &&>);
static_assert(not is_dynamic_castable_v<const volatile int, const int>);
static_assert(not is_dynamic_castable_v<const volatile int, volatile int>);
static_assert(not is_dynamic_castable_v<const volatile int, const volatile int>);
static_assert(not is_dynamic_castable_v<const volatile int, const int &>);
static_assert(not is_dynamic_castable_v<const volatile int, volatile int &>);
static_assert(not is_dynamic_castable_v<const volatile int, const volatile int &>);
static_assert(not is_dynamic_castable_v<const volatile int, const int &&>);
...
static_assert(not is_dynamic_castable_v<const volatile int &&, volatile int &&>);
static_assert(not is_dynamic_castable_v<const volatile int &&, const volatile int &&>);
static_assert(not is_dynamic_castable_v<int, bool>);
static_assert(not is_dynamic_castable_v<int, short>);
static_assert(not is_dynamic_castable_v<int, unsigned short>);
static_assert(not is_dynamic_castable_v<int, char>);
static_assert(not is_dynamic_castable_v<int, unsigned char>);
static_assert(not is_dynamic_castable_v<int, signed char>);
static_assert(not is_dynamic_castable_v<int, unsigned>);
static_assert(not is_dynamic_castable_v<int, long>);
static_assert(not is_dynamic_castable_v<int, unsigned long>);
static_assert(not is_dynamic_castable_v<int, const unsigned>);
static_assert(not is_dynamic_castable_v<int, const long>);
static_assert(not is_dynamic_castable_v<int, const unsigned long>);
static_assert(not is_dynamic_castable_v<int, char8_t>);
static_assert(not is_dynamic_castable_v<int, char16_t>);
static_assert(not is_dynamic_castable_v<int, char32_t>);
static_assert(not is_dynamic_castable_v<int, wchar_t>);
static_assert(not is_dynamic_castable_v<int, float>);
static_assert(not is_dynamic_castable_v<double, float>);
static_assert(not is_dynamic_castable_v<double, int>);
static_assert(not is_dynamic_castable_v<double, unsigned>);
static_assert(not is_dynamic_castable_v<double, long double>);
static_assert(not is_dynamic_castable_v<double, const int>);
static_assert(not is_dynamic_castable_v<double, const unsigned>);
static_assert(not is_dynamic_castable_v<int *, int []>);
static_assert(not is_dynamic_castable_v<const int *, int []>);
static_assert(not is_dynamic_castable_v<int *const, int []>);
static_assert(not is_dynamic_castable_v<const int *const, int []>);
static_assert(not is_dynamic_castable_v<int *, int [42]>);
static_assert(not is_dynamic_castable_v<const int *, int [42]>);
static_assert(not is_dynamic_castable_v<int *const, int [42]>);
static_assert(not is_dynamic_castable_v<const int *const, int [42]>);
static_assert(not is_dynamic_castable_v<int [], initializer_list<int>>);
static_assert(not is_dynamic_castable_v<int [42], initializer_list<int>>);
static_assert(not is_dynamic_castable_v<int *, initializer_list<int>>);
static_assert(not is_dynamic_castable_v<int (&)[], int []>);
static_assert(not is_dynamic_castable_v<int (&&)[], int []>);
static_assert(not is_dynamic_castable_v<int (&)[42], int [42]>);
static_assert(not is_dynamic_castable_v<int (&&)[42], int [42]>);
static_assert(not is_dynamic_castable_v<int (&)[], initializer_list<int>>);
static_assert(not is_dynamic_castable_v<int (&)[42], initializer_list<int>>);
static_assert(not is_dynamic_castable_v<int *, int (&)[]>);
...
static_assert(not is_dynamic_castable_v<const int *const, int (&)[42]>);
static_assert(not is_dynamic_castable_v<const int *const, int (&&)[42]>);
static_assert(not is_dynamic_castable_v<void (*)(), void ()>);
static_assert(not is_dynamic_castable_v<void (), void ()>);
static_assert(not is_dynamic_castable_v<void (&)(), void ()>);
static_assert(not is_dynamic_castable_v<void (&&)(), void ()>);
static_assert(not is_dynamic_castable_v<void (&)(), void (&&)()>);
...
static_assert(not is_dynamic_castable_v<void (*)(), void (&)()>);
static_assert(not is_dynamic_castable_v<void (*)(), void (&&)()>);
static_assert(not is_dynamic_castable_v<void (*const)(), void ()>);
static_assert(not is_dynamic_castable_v<void (*const)(), void (&)()>);
static_assert(not is_dynamic_castable_v<void (*const)(), void (&&)()>);
static_assert(not is_dynamic_castable_v<int *, void *>);
static_assert(not is_dynamic_castable_v<int *, void *const>);
static_assert(not is_dynamic_castable_v<int *, const void *>);
static_assert(not is_dynamic_castable_v<int *, const void *const >);
static_assert(not is_dynamic_castable_v<int *const, void *>);
static_assert(not is_dynamic_castable_v<const int *, void *>);
static_assert(not is_dynamic_castable_v<int [], void *>);
static_assert(not is_dynamic_castable_v<int [], void *const>);
static_assert(not is_dynamic_castable_v<int [], const void *>);
static_assert(not is_dynamic_castable_v<int [], const void *const>);
static_assert(not is_dynamic_castable_v<int [42], void *>);
static_assert(not is_dynamic_castable_v<int [42], void *const>);
static_assert(not is_dynamic_castable_v<int [42], const void *>);
static_assert(not is_dynamic_castable_v<int [42], const void *const>);
static_assert(not is_dynamic_castable_v<const int [], void *>);
static_assert(not is_dynamic_castable_v<const int [], const void *>);
static_assert(not is_dynamic_castable_v<const int [42], const void *>);
static_assert(not is_dynamic_castable_v<int (&)[], void *>);
static_assert(not is_dynamic_castable_v<int (&)[], void *const>);
static_assert(not is_dynamic_castable_v<int (&)[], const void *>);
static_assert(not is_dynamic_castable_v<int (&)[], const void *const>);
...
static_assert(not is_dynamic_castable_v<void (), void *>);
static_assert(not is_dynamic_castable_v<void (*)(), void *>);
static_assert(not is_dynamic_castable_v<void (A::*)(), void *>);
static_assert(not is_dynamic_castable_v<__int128_t, int>);
static_assert(not is_dynamic_castable_v<__uint128_t, int>);
static_assert(not is_dynamic_castable_v<__int128_t, unsigned>);
static_assert(not is_dynamic_castable_v<__uint128_t, unsigned>);
static_assert(not is_dynamic_castable_v<__int128_t, double>);
static_assert(not is_dynamic_castable_v<__uint128_t, double>);
static_assert(not is_dynamic_castable_v<int, C>);
static_assert(not is_dynamic_castable_v<int, D>);
static_assert(not is_dynamic_castable_v<C, int>);
static_assert(not is_dynamic_castable_v<D, int>);
static_assert(not is_dynamic_castable_v<D, short>);
static_assert(not is_dynamic_castable_v<D, bool>);
static_assert(not is_dynamic_castable_v<D, unsigned>);
static_assert(not is_dynamic_castable_v<D, unit_test_is_dynamic_castable>);
static_assert(not is_dynamic_castable_v<unit_test_is_dynamic_castable_base, unit_test_is_dynamic_castable_derived>);
static_assert(not is_dynamic_castable_v<unit_test_is_dynamic_castable_derived, unit_test_is_dynamic_castable_base>);
static_assert(not is_dynamic_castable_v<unit_test_is_dynamic_castable_base *, unit_test_is_dynamic_castable_derived *>);
static_assert(is_dynamic_castable_v<unit_test_is_dynamic_castable_derived *, unit_test_is_dynamic_castable_base *>);
static_assert(not is_dynamic_castable_v<unit_test_is_dynamic_castable_base *, const unit_test_is_dynamic_castable_derived *>);
static_assert(is_dynamic_castable_v<unit_test_is_dynamic_castable_derived *, const unit_test_is_dynamic_castable_base *>);
static_assert(not is_dynamic_castable_v<unit_test_is_dynamic_castable_base *, unit_test_is_dynamic_castable_derived *const>);
static_assert(is_dynamic_castable_v<unit_test_is_dynamic_castable_derived *, unit_test_is_dynamic_castable_base *const>);
static_assert(not is_dynamic_castable_v<unit_test_is_dynamic_castable_base *, const unit_test_is_dynamic_castable_derived *const>);
static_assert(is_dynamic_castable_v<unit_test_is_dynamic_castable_derived *, const unit_test_is_dynamic_castable_base *const>);
static_assert(not is_dynamic_castable_v<const unit_test_is_dynamic_castable_base *, unit_test_is_dynamic_castable_derived *>);
static_assert(not is_dynamic_castable_v<const unit_test_is_dynamic_castable_derived *, unit_test_is_dynamic_castable_base *>);
static_assert(not is_dynamic_castable_v<const unit_test_is_dynamic_castable_base *, const unit_test_is_dynamic_castable_derived *>);
static_assert(is_dynamic_castable_v<const unit_test_is_dynamic_castable_derived *, const unit_test_is_dynamic_castable_base *>);
static_assert(not is_dynamic_castable_v<const unit_test_is_dynamic_castable_base *, unit_test_is_dynamic_castable_derived *const>);
static_assert(not is_dynamic_castable_v<const unit_test_is_dynamic_castable_derived *, unit_test_is_dynamic_castable_base *const>);
static_assert(not is_dynamic_castable_v<const unit_test_is_dynamic_castable_base *, const unit_test_is_dynamic_castable_derived *const>);
static_assert(is_dynamic_castable_v<const unit_test_is_dynamic_castable_derived *, const unit_test_is_dynamic_castable_base *const>);
static_assert(not is_dynamic_castable_v<unit_test_is_dynamic_castable_base *const, unit_test_is_dynamic_castable_derived *>);
static_assert(is_dynamic_castable_v<unit_test_is_dynamic_castable_derived *const, unit_test_is_dynamic_castable_base *>);
static_assert(not is_dynamic_castable_v<unit_test_is_dynamic_castable_base *const, const unit_test_is_dynamic_castable_derived *>);
static_assert(is_dynamic_castable_v<unit_test_is_dynamic_castable_derived *const, const unit_test_is_dynamic_castable_base *>);
static_assert(not is_dynamic_castable_v<unit_test_is_dynamic_castable_base *const, unit_test_is_dynamic_castable_derived *const>);
static_assert(is_dynamic_castable_v<unit_test_is_dynamic_castable_derived *const, unit_test_is_dynamic_castable_base *const>);
static_assert(not is_dynamic_castable_v<unit_test_is_dynamic_castable_base *const, const unit_test_is_dynamic_castable_derived *const>);
static_assert(is_dynamic_castable_v<unit_test_is_dynamic_castable_derived *const, const unit_test_is_dynamic_castable_base *const>);
static_assert(not is_dynamic_castable_v<const unit_test_is_dynamic_castable_base *const, unit_test_is_dynamic_castable_derived *>);
static_assert(not is_dynamic_castable_v<const unit_test_is_dynamic_castable_derived *const, unit_test_is_dynamic_castable_base *>);
static_assert(not is_dynamic_castable_v<const unit_test_is_dynamic_castable_base *const, const unit_test_is_dynamic_castable_derived *>);
static_assert(is_dynamic_castable_v<const unit_test_is_dynamic_castable_derived *const, const unit_test_is_dynamic_castable_base *>);
static_assert(not is_dynamic_castable_v<const unit_test_is_dynamic_castable_base *const, unit_test_is_dynamic_castable_derived *const>);
static_assert(not is_dynamic_castable_v<const unit_test_is_dynamic_castable_derived *const, unit_test_is_dynamic_castable_base *const>);
static_assert(not is_dynamic_castable_v<const unit_test_is_dynamic_castable_base *const, const unit_test_is_dynamic_castable_derived *const>);
static_assert(is_dynamic_castable_v<const unit_test_is_dynamic_castable_derived *const, const unit_test_is_dynamic_castable_base *const>);
static_assert(not is_dynamic_castable_v<unit_test_is_dynamic_castable_base &, unit_test_is_dynamic_castable_derived &>);
static_assert(not is_dynamic_castable_v<unit_test_is_dynamic_castable_base &, unit_test_is_dynamic_castable_derived &&>);
static_assert(is_dynamic_castable_v<unit_test_is_dynamic_castable_derived &, unit_test_is_dynamic_castable_base &>);
static_assert(is_dynamic_castable_v<unit_test_is_dynamic_castable_derived &, unit_test_is_dynamic_castable_base &&>);
...
static_assert(not is_dynamic_castable_v<unit_test_is_dynamic_castable_base &&, const unit_test_is_dynamic_castable_derived &>);
static_assert(not is_dynamic_castable_v<unit_test_is_dynamic_castable_base &&, const unit_test_is_dynamic_castable_derived &&>);
static_assert(not is_dynamic_castable_v<unit_test_is_dynamic_castable_derived &&, const unit_test_is_dynamic_castable_base &>);
static_assert(is_dynamic_castable_v<unit_test_is_dynamic_castable_derived &&, const unit_test_is_dynamic_castable_base &&>);
static_assert(not is_dynamic_castable_v<const unit_test_is_dynamic_castable_base &&, unit_test_is_dynamic_castable_derived &>);
static_assert(not is_dynamic_castable_v<const unit_test_is_dynamic_castable_base &&, unit_test_is_dynamic_castable_derived &&>);
static_assert(not is_dynamic_castable_v<const unit_test_is_dynamic_castable_derived &&, unit_test_is_dynamic_castable_base &>);
...
static_assert(not is_dynamic_castable_v<const unit_test_is_dynamic_castable_derived &&, const unit_test_is_dynamic_castable_base &>);
static_assert(is_dynamic_castable_v<const unit_test_is_dynamic_castable_derived &&, const unit_test_is_dynamic_castable_base &&>);
static_assert(not is_dynamic_castable_v<unit_test_is_dynamic_castable_polymorphic_base, unit_test_is_dynamic_castable_polymorphic_derived_1>);
static_assert(not is_dynamic_castable_v<unit_test_is_dynamic_castable_polymorphic_base, unit_test_is_dynamic_castable_polymorphic_derived_2>);
static_assert(not is_dynamic_castable_v<unit_test_is_dynamic_castable_polymorphic_base, unit_test_is_dynamic_castable_polymorphic_derived_3>);
static_assert(not is_dynamic_castable_v<unit_test_is_dynamic_castable_polymorphic_derived_1, unit_test_is_dynamic_castable_polymorphic_base>);
static_assert(not is_dynamic_castable_v<unit_test_is_dynamic_castable_polymorphic_derived_2, unit_test_is_dynamic_castable_polymorphic_base>);
static_assert(not is_dynamic_castable_v<unit_test_is_dynamic_castable_polymorphic_derived_3, unit_test_is_dynamic_castable_polymorphic_base>);
static_assert(is_dynamic_castable_v<unit_test_is_dynamic_castable_polymorphic_base *, unit_test_is_dynamic_castable_polymorphic_derived_1 *>);
static_assert(is_dynamic_castable_v<unit_test_is_dynamic_castable_polymorphic_base *, unit_test_is_dynamic_castable_polymorphic_derived_2 *>);
static_assert(is_dynamic_castable_v<unit_test_is_dynamic_castable_polymorphic_base *, unit_test_is_dynamic_castable_polymorphic_derived_3 *>);
static_assert(is_dynamic_castable_v<unit_test_is_dynamic_castable_polymorphic_derived_1 *, unit_test_is_dynamic_castable_polymorphic_base *>);
static_assert(is_dynamic_castable_v<unit_test_is_dynamic_castable_polymorphic_derived_2 *, unit_test_is_dynamic_castable_polymorphic_base *>);
static_assert(not is_dynamic_castable_v<unit_test_is_dynamic_castable_polymorphic_derived_3 *, unit_test_is_dynamic_castable_polymorphic_base *>);
static_assert(is_dynamic_castable_v<unit_test_is_dynamic_castable_polymorphic_base &, unit_test_is_dynamic_castable_polymorphic_derived_1 &>);
static_assert(is_dynamic_castable_v<unit_test_is_dynamic_castable_polymorphic_base &, unit_test_is_dynamic_castable_polymorphic_derived_2 &>);
static_assert(is_dynamic_castable_v<unit_test_is_dynamic_castable_polymorphic_base &, unit_test_is_dynamic_castable_polymorphic_derived_3 &>);
...
static_assert(is_dynamic_castable_v<unit_test_is_dynamic_castable_polymorphic_derived_2 &, unit_test_is_dynamic_castable_polymorphic_base &>);
static_assert(not is_dynamic_castable_v<unit_test_is_dynamic_castable_polymorphic_derived_3 &, unit_test_is_dynamic_castable_polymorphic_base &>);
static_assert(not is_dynamic_castable_v<unit_test_is_dynamic_castable_polymorphic_base, unit_test_is_dynamic_castable_polymorphic_virtual_derived_1>);
static_assert(not is_dynamic_castable_v<unit_test_is_dynamic_castable_polymorphic_base, unit_test_is_dynamic_castable_polymorphic_virtual_derived_2>);
static_assert(not is_dynamic_castable_v<unit_test_is_dynamic_castable_polymorphic_base, unit_test_is_dynamic_castable_polymorphic_virtual_derived_final>);
static_assert(not is_dynamic_castable_v<unit_test_is_dynamic_castable_polymorphic_virtual_derived_1, unit_test_is_dynamic_castable_polymorphic_base>);
static_assert(not is_dynamic_castable_v<unit_test_is_dynamic_castable_polymorphic_virtual_derived_2, unit_test_is_dynamic_castable_polymorphic_base>);
static_assert(not is_dynamic_castable_v<unit_test_is_dynamic_castable_polymorphic_virtual_derived_final, unit_test_is_dynamic_castable_polymorphic_base>);
static_assert(not is_dynamic_castable_v<unit_test_is_dynamic_castable_polymorphic_virtual_derived_1, unit_test_is_dynamic_castable_polymorphic_derived_1>);
static_assert(not is_dynamic_castable_v<unit_test_is_dynamic_castable_polymorphic_virtual_derived_2, unit_test_is_dynamic_castable_polymorphic_derived_1>);
static_assert(not is_dynamic_castable_v<unit_test_is_dynamic_castable_polymorphic_virtual_derived_final, unit_test_is_dynamic_castable_polymorphic_derived_1>);
static_assert(is_dynamic_castable_v<unit_test_is_dynamic_castable_polymorphic_base &, unit_test_is_dynamic_castable_polymorphic_virtual_derived_1 &>);
static_assert(is_dynamic_castable_v<unit_test_is_dynamic_castable_polymorphic_base &, unit_test_is_dynamic_castable_polymorphic_virtual_derived_2 &>);
static_assert(is_dynamic_castable_v<unit_test_is_dynamic_castable_polymorphic_base &, unit_test_is_dynamic_castable_polymorphic_virtual_derived_final &>);
static_assert(is_dynamic_castable_v<unit_test_is_dynamic_castable_polymorphic_virtual_derived_1 &, unit_test_is_dynamic_castable_polymorphic_base &>);
static_assert(is_dynamic_castable_v<unit_test_is_dynamic_castable_polymorphic_virtual_derived_2 &, unit_test_is_dynamic_castable_polymorphic_base &>);
static_assert(is_dynamic_castable_v<unit_test_is_dynamic_castable_polymorphic_virtual_derived_final &, unit_test_is_dynamic_castable_polymorphic_base &>);
static_assert(is_dynamic_castable_v<unit_test_is_dynamic_castable_polymorphic_virtual_derived_1 &, unit_test_is_dynamic_castable_polymorphic_derived_1 &>);
static_assert(is_dynamic_castable_v<unit_test_is_dynamic_castable_polymorphic_virtual_derived_2 &, unit_test_is_dynamic_castable_polymorphic_derived_1 &>);
static_assert(is_dynamic_castable_v<unit_test_is_dynamic_castable_polymorphic_virtual_derived_final &, unit_test_is_dynamic_castable_polymorphic_derived_1 &>);
static_assert(is_dynamic_castable_v<unit_test_is_dynamic_castable_polymorphic_base *, unit_test_is_dynamic_castable_polymorphic_virtual_derived_1 *>);
static_assert(is_dynamic_castable_v<unit_test_is_dynamic_castable_polymorphic_base *, unit_test_is_dynamic_castable_polymorphic_virtual_derived_2 *>);
static_assert(is_dynamic_castable_v<unit_test_is_dynamic_castable_polymorphic_base *, unit_test_is_dynamic_castable_polymorphic_virtual_derived_final *>);
static_assert(is_dynamic_castable_v<unit_test_is_dynamic_castable_polymorphic_virtual_derived_1 *, unit_test_is_dynamic_castable_polymorphic_base *>);
...
static_assert(is_dynamic_castable_v<unit_test_is_dynamic_castable_polymorphic_virtual_derived_2 *, unit_test_is_dynamic_castable_polymorphic_derived_1 *>);
static_assert(is_dynamic_castable_v<unit_test_is_dynamic_castable_polymorphic_virtual_derived_final *, unit_test_is_dynamic_castable_polymorphic_derived_1 *>);
static_assert(not is_dynamic_castable_v<unit_test_is_dynamic_castable, int>);
static_assert(not is_dynamic_castable_v<unit_test_is_dynamic_castable, char>);
static_assert(not is_dynamic_castable_v<unit_test_is_dynamic_castable, double>);
static_assert(not is_dynamic_castable_v<unit_test_is_dynamic_castable, void *>);
static_assert(not is_dynamic_castable_v<unit_test_is_dynamic_castable, long>);
static_assert(not is_dynamic_castable_v<unit_test_is_dynamic_castable, int *>);
static_assert(not is_dynamic_castable_v<unsigned short, unit_test_is_dynamic_castable>);
static_assert(not is_dynamic_castable_v<unsigned short &, unit_test_is_dynamic_castable>);
static_assert(not is_dynamic_castable_v<unsigned, unit_test_is_dynamic_castable>);
static_assert(not is_dynamic_castable_v<unsigned long, unit_test_is_dynamic_castable>);
static_assert(not is_dynamic_castable_v<unsigned long, unit_test_is_dynamic_castable &>);
static_assert(not is_dynamic_castable_v<unsigned long, const unit_test_is_dynamic_castable &>);
static_assert(not is_dynamic_castable_v<float, unit_test_is_dynamic_castable>);
static_assert(not is_dynamic_castable_v<double, unit_test_is_dynamic_castable>);
static_assert(not is_dynamic_castable_v<long double, const unit_test_is_dynamic_castable &>);
static_assert(not is_dynamic_castable_v<int **, unit_test_is_dynamic_castable>);        // prefer to operator int **&()
static_assert(not is_dynamic_castable_v<int **&&, unit_test_is_dynamic_castable>);      // still prefer to operator int **&()
__DATA_STRUCTURE_END

__DATA_STRUCTURE_START(unit test for ds::is_const_castable)
struct unit_test_is_const_castable_base {
    int a;
};
struct unit_test_is_const_castable_derived : unit_test_is_const_castable_base {
    int b;
};
struct unit_test_is_const_castable_polymorphic_base {
    int a;
    virtual ~unit_test_is_const_castable_polymorphic_base();
};
struct unit_test_is_const_castable_polymorphic_derived_1 : unit_test_is_const_castable_polymorphic_base {
    int b;
    virtual ~unit_test_is_const_castable_polymorphic_derived_1() override;
};
struct unit_test_is_const_castable_polymorphic_derived_2 : unit_test_is_const_castable_polymorphic_base {
    int c;
};
struct unit_test_is_const_castable_polymorphic_derived_3 : unit_test_is_const_castable_polymorphic_derived_1, unit_test_is_const_castable_polymorphic_derived_2 {
    int d;
};
struct unit_test_is_const_castable_polymorphic_virtual_derived_1 : virtual unit_test_is_const_castable_polymorphic_derived_1 {
    int b;
};
struct unit_test_is_const_castable_polymorphic_virtual_derived_2 : virtual unit_test_is_const_castable_polymorphic_derived_1 {
    int c;
};
struct unit_test_is_const_castable_polymorphic_virtual_derived_final : unit_test_is_const_castable_polymorphic_virtual_derived_1, unit_test_is_const_castable_polymorphic_virtual_derived_2 {
    int d;
};
struct unit_test_is_const_castable {
    unit_test_is_const_castable() = default;
    unit_test_is_const_castable(int);
    explicit unit_test_is_const_castable(char);
    unit_test_is_const_castable(double) = delete;
    explicit unit_test_is_const_castable(void *) = delete;
    unit_test_is_const_castable(int, char);
    explicit unit_test_is_const_castable(long, long);
    unit_test_is_const_castable(initializer_list<int *>);
    explicit unit_test_is_const_castable(initializer_list<char *>);
    unit_test_is_const_castable(initializer_list<double *>, int, char, long);
    template <typename T, typename U, typename V>
    unit_test_is_const_castable(T, U &&, V **);
    unit_test_is_const_castable(void *, void *, void **) = delete;
    operator unsigned short &();
    operator unsigned &() = delete;
    operator const unsigned long &() const &;
    explicit operator float &();
...
static_assert(not is_const_castable_v<int, int>);
static_assert(not is_const_castable_v<int, int &>);
static_assert(is_const_castable_v<int, int &&>);
static_assert(not is_const_castable_v<int, const int>);
static_assert(not is_const_castable_v<int, volatile int>);
static_assert(not is_const_castable_v<int, const volatile int>);
static_assert(not is_const_castable_v<int, const int &>);
static_assert(not is_const_castable_v<int, volatile int &>);
static_assert(not is_const_castable_v<int, const volatile int &>);
static_assert(is_const_castable_v<int, const int &&>);
static_assert(is_const_castable_v<int, volatile int &&>);
static_assert(is_const_castable_v<int, const volatile int &&>);
static_assert(not is_const_castable_v<int, int *>);
static_assert(not is_const_castable_v<int &, int *>);
static_assert(not is_const_castable_v<int &&, int *>);
static_assert(not is_const_castable_v<int, void *>);
static_assert(not is_const_castable_v<int, char *>);
static_assert(not is_const_castable_v<int &, int>);
static_assert(is_const_castable_v<int &, int &>);
static_assert(is_const_castable_v<int &, int &&>);
static_assert(not is_const_castable_v<int &, const int>);
...
static_assert(is_const_castable_v<int &&, volatile int &&>);
static_assert(is_const_castable_v<int &&, const volatile int &&>);
static_assert(not is_const_castable_v<const int, int>);
static_assert(not is_const_castable_v<const int, int &>);
static_assert(is_const_castable_v<const int, int &&>);
static_assert(not is_const_castable_v<const int, const int>);
static_assert(not is_const_castable_v<const int, volatile int>);
static_assert(not is_const_castable_v<const int, const volatile int>);
static_assert(not is_const_castable_v<const int, const int &>);
static_assert(not is_const_castable_v<const int, volatile int &>);
static_assert(not is_const_castable_v<const int, const volatile int &>);
static_assert(is_const_castable_v<const int, const int &&>);
static_assert(is_const_castable_v<const int, volatile int &&>);
static_assert(is_const_castable_v<const int, const volatile int &&>);
static_assert(not is_const_castable_v<volatile int, int>);
static_assert(not is_const_castable_v<volatile int, int &>);
static_assert(is_const_castable_v<volatile int, int &&>);
static_assert(not is_const_castable_v<volatile int, const int>);
static_assert(not is_const_castable_v<volatile int, volatile int>);
static_assert(not is_const_castable_v<volatile int, const volatile int>);
static_assert(not is_const_castable_v<volatile int, const int &>);
static_assert(not is_const_castable_v<volatile int, volatile int &>);
static_assert(not is_const_castable_v<volatile int, const volatile int &>);
static_assert(is_const_castable_v<volatile int, const int &&>);
static_assert(is_const_castable_v<volatile int, volatile int &&>);
static_assert(is_const_castable_v<volatile int, const volatile int &&>);
static_assert(not is_const_castable_v<const volatile int, int>);
static_assert(not is_const_castable_v<const volatile int, int &>);
static_assert(is_const_castable_v<const volatile int, int &&>);
static_assert(not is_const_castable_v<const volatile int, const int>);
static_assert(not is_const_castable_v<const volatile int, volatile int>);
static_assert(not is_const_castable_v<const volatile int, const volatile int>);
static_assert(not is_const_castable_v<const volatile int, const int &>);
static_assert(not is_const_castable_v<const volatile int, volatile int &>);
static_assert(not is_const_castable_v<const volatile int, const volatile int &>);
static_assert(is_const_castable_v<const volatile int, const int &&>);
static_assert(is_const_castable_v<const volatile int, volatile int &&>);
static_assert(is_const_castable_v<const volatile int, const volatile int &&>);
static_assert(not is_const_castable_v<const int &, int>);
static_assert(is_const_castable_v<const int &, int &>);
static_assert(is_const_castable_v<const int &, int &&>);
static_assert(not is_const_castable_v<const int &, const int>);
...
static_assert(is_const_castable_v<const volatile int &&, volatile int &&>);
static_assert(is_const_castable_v<const volatile int &&, const volatile int &&>);
static_assert(not is_const_castable_v<int, bool>);
static_assert(not is_const_castable_v<int, short>);
static_assert(not is_const_castable_v<int, unsigned short>);
static_assert(not is_const_castable_v<int, char>);
static_assert(not is_const_castable_v<int, unsigned char>);
static_assert(not is_const_castable_v<int, signed char>);
static_assert(not is_const_castable_v<int, unsigned>);
static_assert(not is_const_castable_v<int, long>);
static_assert(not is_const_castable_v<int, unsigned long>);
static_assert(not is_const_castable_v<int, const unsigned>);
static_assert(not is_const_castable_v<int, const long>);
static_assert(not is_const_castable_v<int, const unsigned long>);
static_assert(not is_const_castable_v<int, char8_t>);
static_assert(not is_const_castable_v<int, char16_t>);
static_assert(not is_const_castable_v<int, char32_t>);
static_assert(not is_const_castable_v<int, wchar_t>);
static_assert(not is_const_castable_v<int, float>);
static_assert(not is_const_castable_v<double, float>);
static_assert(not is_const_castable_v<double, int>);
static_assert(not is_const_castable_v<double, unsigned>);
static_assert(not is_const_castable_v<double, long double>);
static_assert(not is_const_castable_v<double, const int>);
static_assert(not is_const_castable_v<double, const unsigned>);
static_assert(not is_const_castable_v<int *, int []>);
static_assert(not is_const_castable_v<const int *, int []>);
static_assert(not is_const_castable_v<int *const, int []>);
static_assert(not is_const_castable_v<const int *const, int []>);
static_assert(not is_const_castable_v<int *, int [42]>);
static_assert(not is_const_castable_v<const int *, int [42]>);
static_assert(not is_const_castable_v<int *const, int [42]>);
static_assert(not is_const_castable_v<const int *const, int [42]>);
static_assert(not is_const_castable_v<int [], initializer_list<int>>);
static_assert(not is_const_castable_v<int [42], initializer_list<int>>);
static_assert(not is_const_castable_v<int *, initializer_list<int>>);
static_assert(not is_const_castable_v<int (&)[], int []>);
static_assert(not is_const_castable_v<int (&&)[], int []>);
static_assert(not is_const_castable_v<int (&)[42], int [42]>);
static_assert(not is_const_castable_v<int (&&)[42], int [42]>);
static_assert(is_const_castable_v<const int (&)[], int (&)[]>);
static_assert(is_const_castable_v<const int (&&)[], int (&&)[]>);
static_assert(is_const_castable_v<const int (&)[42], int (&)[42]>);
static_assert(is_const_castable_v<const int (&&)[42], int (&&)[42]>);
static_assert(not is_const_castable_v<int (&)[], initializer_list<int>>);
static_assert(not is_const_castable_v<int (&)[42], initializer_list<int>>);
static_assert(not is_const_castable_v<int *, int (&)[]>);
...
static_assert(not is_const_castable_v<const int *const, int (&)[42]>);
static_assert(not is_const_castable_v<const int *const, int (&&)[42]>);
static_assert(not is_const_castable_v<void (*)(), void ()>);
static_assert(not is_const_castable_v<void (), void ()>);
static_assert(not is_const_castable_v<void (&)(), void ()>);
static_assert(not is_const_castable_v<void (&&)(), void ()>);
static_assert(not is_const_castable_v<void (&)(), void (&&)()>);
...
static_assert(not is_const_castable_v<void (*)(), void (&)()>);
static_assert(not is_const_castable_v<void (*)(), void (&&)()>);
static_assert(not is_const_castable_v<void (*const)(), void ()>);
static_assert(not is_const_castable_v<void (*const)(), void (&)()>);
static_assert(not is_const_castable_v<void (*const)(), void (&&)()>);
static_assert(not is_const_castable_v<int *, void *>);
static_assert(not is_const_castable_v<int *, void *const>);
static_assert(not is_const_castable_v<int *, const void *>);
static_assert(not is_const_castable_v<int *, const void *const >);
static_assert(not is_const_castable_v<int *const, void *>);
static_assert(not is_const_castable_v<const int *, void *>);
static_assert(not is_const_castable_v<int [], void *>);
static_assert(not is_const_castable_v<int [], void *const>);
static_assert(not is_const_castable_v<int [], const void *>);
static_assert(not is_const_castable_v<int [], const void *const>);
static_assert(not is_const_castable_v<int [42], void *>);
static_assert(not is_const_castable_v<int [42], void *const>);
static_assert(not is_const_castable_v<int [42], const void *>);
static_assert(not is_const_castable_v<int [42], const void *const>);
static_assert(not is_const_castable_v<const int [], void *>);
static_assert(not is_const_castable_v<const int [], const void *>);
static_assert(not is_const_castable_v<const int [42], const void *>);
static_assert(not is_const_castable_v<int (&)[], void *>);
static_assert(not is_const_castable_v<int (&)[], void *const>);
static_assert(not is_const_castable_v<int (&)[], const void *>);
static_assert(not is_const_castable_v<int (&)[], const void *const>);
...
static_assert(not is_const_castable_v<void (), void *>);
static_assert(not is_const_castable_v<void (*)(), void *>);
static_assert(not is_const_castable_v<void (A::*)(), void *>);
static_assert(not is_const_castable_v<__int128_t, int>);
static_assert(not is_const_castable_v<__uint128_t, int>);
static_assert(not is_const_castable_v<__int128_t, unsigned>);
static_assert(not is_const_castable_v<__uint128_t, unsigned>);
static_assert(not is_const_castable_v<__uint128_t, double>);
static_assert(not is_const_castable_v<int, C>);
static_assert(not is_const_castable_v<int, D>);
static_assert(not is_const_castable_v<C, int>);
static_assert(not is_const_castable_v<D, int>);
static_assert(not is_const_castable_v<D, short>);
static_assert(not is_const_castable_v<D, bool>);
static_assert(not is_const_castable_v<D, unsigned>);
static_assert(not is_const_castable_v<D, unit_test_is_const_castable>);
static_assert(not is_const_castable_v<unit_test_is_const_castable_base, unit_test_is_const_castable_derived>);
static_assert(not is_const_castable_v<unit_test_is_const_castable_derived, unit_test_is_const_castable_base>);
static_assert(not is_const_castable_v<unit_test_is_const_castable_base *, unit_test_is_const_castable_derived *>);
static_assert(not is_const_castable_v<unit_test_is_const_castable_derived *, unit_test_is_const_castable_base *>);
static_assert(not is_const_castable_v<unit_test_is_const_castable_base *, const unit_test_is_const_castable_derived *>);
static_assert(not is_const_castable_v<unit_test_is_const_castable_derived *, const unit_test_is_const_castable_base *>);
static_assert(not is_const_castable_v<unit_test_is_const_castable_base *, unit_test_is_const_castable_derived *const>);
static_assert(not is_const_castable_v<unit_test_is_const_castable_derived *, unit_test_is_const_castable_base *const>);
static_assert(not is_const_castable_v<unit_test_is_const_castable_base *, const unit_test_is_const_castable_derived *const>);
static_assert(not is_const_castable_v<unit_test_is_const_castable_derived *, const unit_test_is_const_castable_base *const>);
static_assert(not is_const_castable_v<const unit_test_is_const_castable_base *, unit_test_is_const_castable_derived *>);
static_assert(not is_const_castable_v<const unit_test_is_const_castable_derived *, unit_test_is_const_castable_base *>);
static_assert(not is_const_castable_v<const unit_test_is_const_castable_base *, const unit_test_is_const_castable_derived *>);
static_assert(not is_const_castable_v<const unit_test_is_const_castable_derived *, const unit_test_is_const_castable_base *>);
static_assert(not is_const_castable_v<const unit_test_is_const_castable_base *, unit_test_is_const_castable_derived *const>);
static_assert(not is_const_castable_v<const unit_test_is_const_castable_derived *, unit_test_is_const_castable_base *const>);
static_assert(not is_const_castable_v<const unit_test_is_const_castable_base *, const unit_test_is_const_castable_derived *const>);
static_assert(not is_const_castable_v<const unit_test_is_const_castable_derived *, const unit_test_is_const_castable_base *const>);
static_assert(not is_const_castable_v<unit_test_is_const_castable_base *const, unit_test_is_const_castable_derived *>);
static_assert(not is_const_castable_v<unit_test_is_const_castable_derived *const, unit_test_is_const_castable_base *>);
static_assert(not is_const_castable_v<unit_test_is_const_castable_base *const, const unit_test_is_const_castable_derived *>);
static_assert(not is_const_castable_v<unit_test_is_const_castable_derived *const, const unit_test_is_const_castable_base *>);
static_assert(not is_const_castable_v<unit_test_is_const_castable_base *const, unit_test_is_const_castable_derived *const>);
static_assert(not is_const_castable_v<unit_test_is_const_castable_derived *const, unit_test_is_const_castable_base *const>);
static_assert(not is_const_castable_v<unit_test_is_const_castable_base *const, const unit_test_is_const_castable_derived *const>);
static_assert(not is_const_castable_v<unit_test_is_const_castable_derived *const, const unit_test_is_const_castable_base *const>);
static_assert(not is_const_castable_v<const unit_test_is_const_castable_base *const, unit_test_is_const_castable_derived *>);
static_assert(not is_const_castable_v<const unit_test_is_const_castable_derived *const, unit_test_is_const_castable_base *>);
static_assert(not is_const_castable_v<const unit_test_is_const_castable_base *const, const unit_test_is_const_castable_derived *>);
static_assert(not is_const_castable_v<const unit_test_is_const_castable_derived *const, const unit_test_is_const_castable_base *>);
static_assert(not is_const_castable_v<const unit_test_is_const_castable_base *const, unit_test_is_const_castable_derived *const>);
static_assert(not is_const_castable_v<const unit_test_is_const_castable_derived *const, unit_test_is_const_castable_base *const>);
static_assert(not is_const_castable_v<const unit_test_is_const_castable_base *const, const unit_test_is_const_castable_derived *const>);
static_assert(not is_const_castable_v<const unit_test_is_const_castable_derived *const, const unit_test_is_const_castable_base *const>);
static_assert(not is_const_castable_v<unit_test_is_const_castable_base &, unit_test_is_const_castable_derived &>);
static_assert(not is_const_castable_v<unit_test_is_const_castable_base &, unit_test_is_const_castable_derived &&>);
static_assert(not is_const_castable_v<unit_test_is_const_castable_derived &, unit_test_is_const_castable_base &>);
static_assert(not is_const_castable_v<unit_test_is_const_castable_derived &, unit_test_is_const_castable_base &&>);
...
static_assert(not is_const_castable_v<const unit_test_is_const_castable_derived &&, const unit_test_is_const_castable_base &>);
static_assert(not is_const_castable_v<const unit_test_is_const_castable_derived &&, const unit_test_is_const_castable_base &&>);
static_assert(not is_const_castable_v<unit_test_is_const_castable_polymorphic_base, unit_test_is_const_castable_polymorphic_derived_1>);
static_assert(not is_const_castable_v<unit_test_is_const_castable_polymorphic_base, unit_test_is_const_castable_polymorphic_derived_2>);
static_assert(not is_const_castable_v<unit_test_is_const_castable_polymorphic_base, unit_test_is_const_castable_polymorphic_derived_3>);
static_assert(not is_const_castable_v<unit_test_is_const_castable_polymorphic_derived_1, unit_test_is_const_castable_polymorphic_base>);
static_assert(not is_const_castable_v<unit_test_is_const_castable_polymorphic_derived_2, unit_test_is_const_castable_polymorphic_base>);
static_assert(not is_const_castable_v<unit_test_is_const_castable_polymorphic_derived_3, unit_test_is_const_castable_polymorphic_base>);
static_assert(not is_const_castable_v<unit_test_is_const_castable_polymorphic_base *, unit_test_is_const_castable_polymorphic_derived_1 *>);
static_assert(not is_const_castable_v<unit_test_is_const_castable_polymorphic_base *, unit_test_is_const_castable_polymorphic_derived_2 *>);
static_assert(not is_const_castable_v<unit_test_is_const_castable_polymorphic_base *, unit_test_is_const_castable_polymorphic_derived_3 *>);
static_assert(not is_const_castable_v<unit_test_is_const_castable_polymorphic_derived_1 *, unit_test_is_const_castable_polymorphic_base *>);
...
static_assert(not is_const_castable_v<unit_test_is_const_castable_polymorphic_derived_2 &, unit_test_is_const_castable_polymorphic_base &>);
static_assert(not is_const_castable_v<unit_test_is_const_castable_polymorphic_derived_3 &, unit_test_is_const_castable_polymorphic_base &>);
static_assert(not is_const_castable_v<unit_test_is_const_castable_polymorphic_base, unit_test_is_const_castable_polymorphic_virtual_derived_1>);
static_assert(not is_const_castable_v<unit_test_is_const_castable_polymorphic_base, unit_test_is_const_castable_polymorphic_virtual_derived_2>);
static_assert(not is_const_castable_v<unit_test_is_const_castable_polymorphic_base, unit_test_is_const_castable_polymorphic_virtual_derived_final>);
static_assert(not is_const_castable_v<unit_test_is_const_castable_polymorphic_virtual_derived_1, unit_test_is_const_castable_polymorphic_base>);
static_assert(not is_const_castable_v<unit_test_is_const_castable_polymorphic_virtual_derived_2, unit_test_is_const_castable_polymorphic_base>);
static_assert(not is_const_castable_v<unit_test_is_const_castable_polymorphic_virtual_derived_final, unit_test_is_const_castable_polymorphic_base>);
static_assert(not is_const_castable_v<unit_test_is_const_castable_polymorphic_virtual_derived_1, unit_test_is_const_castable_polymorphic_derived_1>);
static_assert(not is_const_castable_v<unit_test_is_const_castable_polymorphic_virtual_derived_2, unit_test_is_const_castable_polymorphic_derived_1>);
static_assert(not is_const_castable_v<unit_test_is_const_castable_polymorphic_virtual_derived_final, unit_test_is_const_castable_polymorphic_derived_1>);
static_assert(not is_const_castable_v<unit_test_is_const_castable_polymorphic_base &, unit_test_is_const_castable_polymorphic_virtual_derived_1 &>);
static_assert(not is_const_castable_v<unit_test_is_const_castable_polymorphic_base &, unit_test_is_const_castable_polymorphic_virtual_derived_2 &>);
static_assert(not is_const_castable_v<unit_test_is_const_castable_polymorphic_base &, unit_test_is_const_castable_polymorphic_virtual_derived_final &>);
static_assert(not is_const_castable_v<unit_test_is_const_castable_polymorphic_virtual_derived_1 &, unit_test_is_const_castable_polymorphic_base &>);
...
static_assert(not is_const_castable_v<unit_test_is_const_castable_polymorphic_virtual_derived_2 *, unit_test_is_const_castable_polymorphic_derived_1 *>);
static_assert(not is_const_castable_v<unit_test_is_const_castable_polymorphic_virtual_derived_final *, unit_test_is_const_castable_polymorphic_derived_1 *>);
static_assert(not is_const_castable_v<unit_test_is_const_castable, int>);
static_assert(not is_const_castable_v<unit_test_is_const_castable, char>);
static_assert(not is_const_castable_v<unit_test_is_const_castable, double>);
static_assert(not is_const_castable_v<unit_test_is_const_castable, void *>);
static_assert(not is_const_castable_v<unit_test_is_const_castable, long>);
static_assert(not is_const_castable_v<unit_test_is_const_castable, int *>);
static_assert(not is_const_castable_v<unsigned short, unit_test_is_const_castable>);
static_assert(not is_const_castable_v<unsigned short &, unit_test_is_const_castable>);
static_assert(not is_const_castable_v<unsigned, unit_test_is_const_castable>);
static_assert(not is_const_castable_v<unsigned long, unit_test_is_const_castable>);
static_assert(not is_const_castable_v<unsigned long, unit_test_is_const_castable &>);
static_assert(not is_const_castable_v<unsigned long, const unit_test_is_const_castable &>);
static_assert(not is_const_castable_v<float, unit_test_is_const_castable>);
static_assert(not is_const_castable_v<double, unit_test_is_const_castable>);
static_assert(not is_const_castable_v<long double, const unit_test_is_const_castable &>);
static_assert(not is_const_castable_v<int **, unit_test_is_const_castable>);        // prefer to operator int **&()
static_assert(not is_const_castable_v<int **&&, unit_test_is_const_castable>);      // still prefer to operator int **&()
__DATA_STRUCTURE_END

__DATA_STRUCTURE_START(unit test for ds::is_reinterpret_castable)
struct unit_test_is_reinterpret_castable_base {
    int a;
};
struct unit_test_is_reinterpret_castable_derived : unit_test_is_reinterpret_castable_base {
    int b;
};
struct unit_test_is_reinterpret_castable_polymorphic_base {
    int a;
    virtual ~unit_test_is_reinterpret_castable_polymorphic_base();
};
struct unit_test_is_reinterpret_castable_polymorphic_derived_1 : unit_test_is_reinterpret_castable_polymorphic_base {
    int b;
    virtual ~unit_test_is_reinterpret_castable_polymorphic_derived_1() override;
};
struct unit_test_is_reinterpret_castable_polymorphic_derived_2 : unit_test_is_reinterpret_castable_polymorphic_base {
    int c;
};
struct unit_test_is_reinterpret_castable_polymorphic_derived_3 : unit_test_is_reinterpret_castable_polymorphic_derived_1, unit_test_is_reinterpret_castable_polymorphic_derived_2 {
    int d;
};
struct unit_test_is_reinterpret_castable_polymorphic_virtual_derived_1 : virtual unit_test_is_reinterpret_castable_polymorphic_derived_1 {
    int b;
};
struct unit_test_is_reinterpret_castable_polymorphic_virtual_derived_2 : virtual unit_test_is_reinterpret_castable_polymorphic_derived_1 {
    int c;
};
struct unit_test_is_reinterpret_castable_polymorphic_virtual_derived_final : unit_test_is_reinterpret_castable_polymorphic_virtual_derived_1, unit_test_is_reinterpret_castable_polymorphic_virtual_derived_2 {
    int d;
};
struct unit_test_is_reinterpret_castable {
    unit_test_is_reinterpret_castable() = default;
    unit_test_is_reinterpret_castable(int);
    explicit unit_test_is_reinterpret_castable(char);
    unit_test_is_reinterpret_castable(double) = delete;
    explicit unit_test_is_reinterpret_castable(void *) = delete;
    unit_test_is_reinterpret_castable(int, char);
    explicit unit_test_is_reinterpret_castable(long, long);
    unit_test_is_reinterpret_castable(initializer_list<int *>);
    explicit unit_test_is_reinterpret_castable(initializer_list<char *>);
    unit_test_is_reinterpret_castable(initializer_list<double *>, int, char, long);
    template <typename T, typename U, typename V>
    unit_test_is_reinterpret_castable(T, U &&, V **);
    unit_test_is_reinterpret_castable(void *, void *, void **) = delete;
    operator unsigned short &();
    operator unsigned &() = delete;
    operator const unsigned long &() const &;
    explicit operator float &();
...
static_assert(is_reinterpret_castable_v<int, int>);
static_assert(is_reinterpret_castable_v<int, int &>);
static_assert(is_reinterpret_castable_v<int, int &&>);
static_assert(is_reinterpret_castable_v<int, const int>);
static_assert(is_reinterpret_castable_v<int, volatile int>);
static_assert(is_reinterpret_castable_v<int, const volatile int>);
static_assert(is_reinterpret_castable_v<int, const int &>);
static_assert(is_reinterpret_castable_v<int, volatile int &>);
static_assert(is_reinterpret_castable_v<int, const volatile int &>);
static_assert(is_reinterpret_castable_v<int, const int &&>);
...
static_assert(is_reinterpret_castable_v<int &, int *>);
static_assert(is_reinterpret_castable_v<int &&, int *>);
static_assert(is_reinterpret_castable_v<int, void *>);
static_assert(is_reinterpret_castable_v<int, char *>);
static_assert(is_reinterpret_castable_v<int &, int>);
static_assert(is_reinterpret_castable_v<int &, int &>);
static_assert(is_reinterpret_castable_v<int &, int &&>);
static_assert(is_reinterpret_castable_v<int &, const int>);
...
static_assert(is_reinterpret_castable_v<int &&, volatile int &&>);
static_assert(is_reinterpret_castable_v<int &&, const volatile int &&>);
static_assert(is_reinterpret_castable_v<const int, int>);
static_assert(not is_reinterpret_castable_v<const int, int &>);
static_assert(not is_reinterpret_castable_v<const int, int &&>);
static_assert(is_reinterpret_castable_v<const int, const int>);
static_assert(is_reinterpret_castable_v<const int, volatile int>);
static_assert(is_reinterpret_castable_v<const int, const volatile int>);
static_assert(is_reinterpret_castable_v<const int, const int &>);
static_assert(not is_reinterpret_castable_v<const int, volatile int &>);
static_assert(is_reinterpret_castable_v<const int, const volatile int &>);
static_assert(is_reinterpret_castable_v<const int, const int &&>);
static_assert(not is_reinterpret_castable_v<const int, volatile int &&>);
static_assert(is_reinterpret_castable_v<const int, const volatile int &&>);
static_assert(is_reinterpret_castable_v<volatile int, int>);
static_assert(not is_reinterpret_castable_v<volatile int, int &>);
static_assert(not is_reinterpret_castable_v<volatile int, int &&>);
static_assert(is_reinterpret_castable_v<volatile int, const int>);
static_assert(is_reinterpret_castable_v<volatile int, volatile int>);
static_assert(is_reinterpret_castable_v<volatile int, const volatile int>);
static_assert(not is_reinterpret_castable_v<volatile int, const int &>);
static_assert(is_reinterpret_castable_v<volatile int, volatile int &>);
static_assert(is_reinterpret_castable_v<volatile int, const volatile int &>);
static_assert(not is_reinterpret_castable_v<volatile int, const int &&>);
static_assert(is_reinterpret_castable_v<volatile int, volatile int &&>);
static_assert(is_reinterpret_castable_v<volatile int, const volatile int &&>);
static_assert(is_reinterpret_castable_v<const volatile int, int>);
static_assert(not is_reinterpret_castable_v<const volatile int, int &>);
static_assert(not is_reinterpret_castable_v<const volatile int, int &&>);
static_assert(is_reinterpret_castable_v<const volatile int, const int>);
static_assert(is_reinterpret_castable_v<const volatile int, volatile int>);
static_assert(is_reinterpret_castable_v<const volatile int, const volatile int>);
static_assert(not is_reinterpret_castable_v<const volatile int, const int &>);
static_assert(not is_reinterpret_castable_v<const volatile int, volatile int &>);
static_assert(is_reinterpret_castable_v<const volatile int, const volatile int &>);
static_assert(not is_reinterpret_castable_v<const volatile int, const int &&>);
static_assert(not is_reinterpret_castable_v<const volatile int, volatile int &&>);
static_assert(is_reinterpret_castable_v<const volatile int, const volatile int &&>);
...
static_assert(not is_reinterpret_castable_v<const volatile int &&, volatile int &&>);
static_assert(is_reinterpret_castable_v<const volatile int &&, const volatile int &&>);
static_assert(not is_reinterpret_castable_v<int, bool>);
static_assert(not is_reinterpret_castable_v<int, short>);
static_assert(not is_reinterpret_castable_v<int, unsigned short>);
static_assert(not is_reinterpret_castable_v<int, char>);
static_assert(not is_reinterpret_castable_v<int, unsigned char>);
static_assert(not is_reinterpret_castable_v<int, signed char>);
static_assert(not is_reinterpret_castable_v<int, unsigned>);
static_assert(not is_reinterpret_castable_v<int, long>);
static_assert(not is_reinterpret_castable_v<int, unsigned long>);
static_assert(not is_reinterpret_castable_v<int, const unsigned>);
static_assert(not is_reinterpret_castable_v<int, const long>);
static_assert(not is_reinterpret_castable_v<int, const unsigned long>);
static_assert(not is_reinterpret_castable_v<int, char8_t>);
static_assert(not is_reinterpret_castable_v<int, char16_t>);
static_assert(not is_reinterpret_castable_v<int, char32_t>);
static_assert(not is_reinterpret_castable_v<int, wchar_t>);
static_assert(not is_reinterpret_castable_v<int, float>);
static_assert(not is_reinterpret_castable_v<double, float>);
static_assert(not is_reinterpret_castable_v<double, int>);
static_assert(not is_reinterpret_castable_v<double, unsigned>);
static_assert(not is_reinterpret_castable_v<double, long double>);
static_assert(not is_reinterpret_castable_v<double, const int>);
static_assert(not is_reinterpret_castable_v<double, const unsigned>);
static_assert(not is_reinterpret_castable_v<int *, int []>);
static_assert(not is_reinterpret_castable_v<const int *, int []>);
static_assert(not is_reinterpret_castable_v<int *const, int []>);
static_assert(not is_reinterpret_castable_v<const int *const, int []>);
static_assert(not is_reinterpret_castable_v<int *, int [42]>);
static_assert(not is_reinterpret_castable_v<const int *, int [42]>);
static_assert(not is_reinterpret_castable_v<int *const, int [42]>);
static_assert(not is_reinterpret_castable_v<const int *const, int [42]>);
static_assert(not is_reinterpret_castable_v<int [], initializer_list<int>>);
static_assert(not is_reinterpret_castable_v<int [42], initializer_list<int>>);
static_assert(not is_reinterpret_castable_v<int *, initializer_list<int>>);
static_assert(not is_reinterpret_castable_v<int (&)[], int []>);
static_assert(not is_reinterpret_castable_v<int (&&)[], int []>);
static_assert(not is_reinterpret_castable_v<int (&)[42], int [42]>);
static_assert(not is_reinterpret_castable_v<int (&&)[42], int [42]>);
static_assert(not is_reinterpret_castable_v<int (&)[], initializer_list<int>>);
static_assert(not is_reinterpret_castable_v<int (&)[42], initializer_list<int>>);
static_assert(is_reinterpret_castable_v<int *, int (&)[]>);
static_assert(is_reinterpret_castable_v<int *, int (&&)[]>);
static_assert(is_reinterpret_castable_v<int *, int (&)[42]>);
static_assert(is_reinterpret_castable_v<int *, int (&&)[42]>);
static_assert(not is_reinterpret_castable_v<const int *, int (&)[]>);
static_assert(not is_reinterpret_castable_v<const int *, int (&&)[]>);
static_assert(not is_reinterpret_castable_v<const int *, int (&)[42]>);
...
static_assert(not is_reinterpret_castable_v<const int *const, int (&)[42]>);
static_assert(not is_reinterpret_castable_v<const int *const, int (&&)[42]>);
static_assert(not is_reinterpret_castable_v<void (*)(), void ()>);
static_assert(not is_reinterpret_castable_v<void (), void ()>);
static_assert(not is_reinterpret_castable_v<void (&)(), void ()>);
static_assert(not is_reinterpret_castable_v<void (&&)(), void ()>);
static_assert(is_reinterpret_castable_v<void (&)(), void (&&)()>);
static_assert(is_reinterpret_castable_v<void (&&)(), void (&)()>);
static_assert(is_reinterpret_castable_v<void (*)(), void (&)()>);
static_assert(is_reinterpret_castable_v<void (*)(), void (&&)()>);
static_assert(not is_reinterpret_castable_v<void (*const)(), void ()>);
static_assert(not is_reinterpret_castable_v<void (*const)(), void (&)()>);
static_assert(not is_reinterpret_castable_v<void (*const)(), void (&&)()>);
static_assert(is_reinterpret_castable_v<int *, void *>);
static_assert(is_reinterpret_castable_v<int *, void *const>);
static_assert(is_reinterpret_castable_v<int *, const void *>);
static_assert(is_reinterpret_castable_v<int *, const void *const >);
static_assert(is_reinterpret_castable_v<int *const, void *>);
static_assert(not is_reinterpret_castable_v<const int *, void *>);
static_assert(is_reinterpret_castable_v<int [], void *>);
static_assert(is_reinterpret_castable_v<int [], void *const>);
static_assert(is_reinterpret_castable_v<int [], const void *>);
static_assert(is_reinterpret_castable_v<int [], const void *const>);
static_assert(is_reinterpret_castable_v<int [42], void *>);
static_assert(is_reinterpret_castable_v<int [42], void *const>);
static_assert(is_reinterpret_castable_v<int [42], const void *>);
static_assert(is_reinterpret_castable_v<int [42], const void *const>);
static_assert(not is_reinterpret_castable_v<const int [], void *>);
static_assert(is_reinterpret_castable_v<const int [], const void *>);
static_assert(is_reinterpret_castable_v<const int [42], const void *>);
static_assert(is_reinterpret_castable_v<int (&)[], void *>);
static_assert(is_reinterpret_castable_v<int (&)[], void *const>);
static_assert(is_reinterpret_castable_v<int (&)[], const void *>);
static_assert(is_reinterpret_castable_v<int (&)[], const void *const>);
...
static_assert(is_reinterpret_castable_v<void (), void *>);
static_assert(is_reinterpret_castable_v<void (*)(), void *>);
static_assert(not is_reinterpret_castable_v<void (A::*)(), void *>);
static_assert(not is_reinterpret_castable_v<__int128_t, int>);
static_assert(not is_reinterpret_castable_v<__uint128_t, int>);
static_assert(not is_reinterpret_castable_v<__int128_t, unsigned>);
static_assert(not is_reinterpret_castable_v<__uint128_t, unsigned>);
static_assert(not is_reinterpret_castable_v<__uint128_t, double>);
static_assert(not is_reinterpret_castable_v<int, C>);
static_assert(not is_reinterpret_castable_v<int, D>);
static_assert(not is_reinterpret_castable_v<C, int>);
static_assert(not is_reinterpret_castable_v<D, int>);
static_assert(not is_reinterpret_castable_v<D, short>);
static_assert(not is_reinterpret_castable_v<D, bool>);
static_assert(not is_reinterpret_castable_v<D, unsigned>);
static_assert(not is_reinterpret_castable_v<D, unit_test_is_reinterpret_castable>);
static_assert(not is_reinterpret_castable_v<unit_test_is_reinterpret_castable_base, unit_test_is_reinterpret_castable_derived>);
static_assert(not is_reinterpret_castable_v<unit_test_is_reinterpret_castable_derived, unit_test_is_reinterpret_castable_base>);
static_assert(is_reinterpret_castable_v<unit_test_is_reinterpret_castable_base *, unit_test_is_reinterpret_castable_derived *>);
static_assert(is_reinterpret_castable_v<unit_test_is_reinterpret_castable_derived *, unit_test_is_reinterpret_castable_base *>);
static_assert(is_reinterpret_castable_v<unit_test_is_reinterpret_castable_base *, const unit_test_is_reinterpret_castable_derived *>);
static_assert(is_reinterpret_castable_v<unit_test_is_reinterpret_castable_derived *, const unit_test_is_reinterpret_castable_base *>);
static_assert(is_reinterpret_castable_v<unit_test_is_reinterpret_castable_base *, unit_test_is_reinterpret_castable_derived *const>);
static_assert(is_reinterpret_castable_v<unit_test_is_reinterpret_castable_derived *, unit_test_is_reinterpret_castable_base *const>);
static_assert(is_reinterpret_castable_v<unit_test_is_reinterpret_castable_base *, const unit_test_is_reinterpret_castable_derived *const>);
static_assert(is_reinterpret_castable_v<unit_test_is_reinterpret_castable_derived *, const unit_test_is_reinterpret_castable_base *const>);
static_assert(not is_reinterpret_castable_v<const unit_test_is_reinterpret_castable_base *, unit_test_is_reinterpret_castable_derived *>);
static_assert(not is_reinterpret_castable_v<const unit_test_is_reinterpret_castable_derived *, unit_test_is_reinterpret_castable_base *>);
static_assert(is_reinterpret_castable_v<const unit_test_is_reinterpret_castable_base *, const unit_test_is_reinterpret_castable_derived *>);
static_assert(is_reinterpret_castable_v<const unit_test_is_reinterpret_castable_derived *, const unit_test_is_reinterpret_castable_base *>);
static_assert(not is_reinterpret_castable_v<const unit_test_is_reinterpret_castable_base *, unit_test_is_reinterpret_castable_derived *const>);
static_assert(not is_reinterpret_castable_v<const unit_test_is_reinterpret_castable_derived *, unit_test_is_reinterpret_castable_base *const>);
static_assert(is_reinterpret_castable_v<const unit_test_is_reinterpret_castable_base *, const unit_test_is_reinterpret_castable_derived *const>);
static_assert(is_reinterpret_castable_v<const unit_test_is_reinterpret_castable_derived *, const unit_test_is_reinterpret_castable_base *const>);
static_assert(is_reinterpret_castable_v<unit_test_is_reinterpret_castable_base *const, unit_test_is_reinterpret_castable_derived *>);
static_assert(is_reinterpret_castable_v<unit_test_is_reinterpret_castable_derived *const, unit_test_is_reinterpret_castable_base *>);
static_assert(is_reinterpret_castable_v<unit_test_is_reinterpret_castable_base *const, const unit_test_is_reinterpret_castable_derived *>);
static_assert(is_reinterpret_castable_v<unit_test_is_reinterpret_castable_derived *const, const unit_test_is_reinterpret_castable_base *>);
static_assert(is_reinterpret_castable_v<unit_test_is_reinterpret_castable_base *const, unit_test_is_reinterpret_castable_derived *const>);
static_assert(is_reinterpret_castable_v<unit_test_is_reinterpret_castable_derived *const, unit_test_is_reinterpret_castable_base *const>);
static_assert(is_reinterpret_castable_v<unit_test_is_reinterpret_castable_base *const, const unit_test_is_reinterpret_castable_derived *const>);
static_assert(is_reinterpret_castable_v<unit_test_is_reinterpret_castable_derived *const, const unit_test_is_reinterpret_castable_base *const>);
static_assert(not is_reinterpret_castable_v<const unit_test_is_reinterpret_castable_base *const, unit_test_is_reinterpret_castable_derived *>);
static_assert(not is_reinterpret_castable_v<const unit_test_is_reinterpret_castable_derived *const, unit_test_is_reinterpret_castable_base *>);
static_assert(is_reinterpret_castable_v<const unit_test_is_reinterpret_castable_base *const, const unit_test_is_reinterpret_castable_derived *>);
static_assert(is_reinterpret_castable_v<const unit_test_is_reinterpret_castable_derived *const, const unit_test_is_reinterpret_castable_base *>);
static_assert(not is_reinterpret_castable_v<const unit_test_is_reinterpret_castable_base *const, unit_test_is_reinterpret_castable_derived *const>);
static_assert(not is_reinterpret_castable_v<const unit_test_is_reinterpret_castable_derived *const, unit_test_is_reinterpret_castable_base *const>);
static_assert(is_reinterpret_castable_v<const unit_test_is_reinterpret_castable_base *const, const unit_test_is_reinterpret_castable_derived *const>);
static_assert(is_reinterpret_castable_v<const unit_test_is_reinterpret_castable_derived *const, const unit_test_is_reinterpret_castable_base *const>);
static_assert(is_reinterpret_castable_v<unit_test_is_reinterpret_castable_base &, unit_test_is_reinterpret_castable_derived &>);
static_assert(is_reinterpret_castable_v<unit_test_is_reinterpret_castable_base &, unit_test_is_reinterpret_castable_derived &&>);
static_assert(is_reinterpret_castable_v<unit_test_is_reinterpret_castable_derived &, unit_test_is_reinterpret_castable_base &>);
static_assert(is_reinterpret_castable_v<unit_test_is_reinterpret_castable_derived &, unit_test_is_reinterpret_castable_base &&>);
...
static_assert(is_reinterpret_castable_v<const unit_test_is_reinterpret_castable_derived &&, const unit_test_is_reinterpret_castable_base &>);
static_assert(is_reinterpret_castable_v<const unit_test_is_reinterpret_castable_derived &&, const unit_test_is_reinterpret_castable_base &&>);
static_assert(not is_reinterpret_castable_v<unit_test_is_reinterpret_castable_polymorphic_base, unit_test_is_reinterpret_castable_polymorphic_derived_1>);
static_assert(not is_reinterpret_castable_v<unit_test_is_reinterpret_castable_polymorphic_base, unit_test_is_reinterpret_castable_polymorphic_derived_2>);
static_assert(not is_reinterpret_castable_v<unit_test_is_reinterpret_castable_polymorphic_base, unit_test_is_reinterpret_castable_polymorphic_derived_3>);
static_assert(not is_reinterpret_castable_v<unit_test_is_reinterpret_castable_polymorphic_derived_1, unit_test_is_reinterpret_castable_polymorphic_base>);
static_assert(not is_reinterpret_castable_v<unit_test_is_reinterpret_castable_polymorphic_derived_2, unit_test_is_reinterpret_castable_polymorphic_base>);
static_assert(not is_reinterpret_castable_v<unit_test_is_reinterpret_castable_polymorphic_derived_3, unit_test_is_reinterpret_castable_polymorphic_base>);
static_assert(is_reinterpret_castable_v<unit_test_is_reinterpret_castable_polymorphic_base *, unit_test_is_reinterpret_castable_polymorphic_derived_1 *>);
static_assert(is_reinterpret_castable_v<unit_test_is_reinterpret_castable_polymorphic_base *, unit_test_is_reinterpret_castable_polymorphic_derived_2 *>);
static_assert(is_reinterpret_castable_v<unit_test_is_reinterpret_castable_polymorphic_base *, unit_test_is_reinterpret_castable_polymorphic_derived_3 *>);
static_assert(is_reinterpret_castable_v<unit_test_is_reinterpret_castable_polymorphic_derived_1 *, unit_test_is_reinterpret_castable_polymorphic_base *>);
static_assert(is_reinterpret_castable_v<unit_test_is_reinterpret_castable_polymorphic_derived_2 *, unit_test_is_reinterpret_castable_polymorphic_base *>);
static_assert(is_reinterpret_castable_v<unit_test_is_reinterpret_castable_polymorphic_derived_3 *, unit_test_is_reinterpret_castable_polymorphic_base *>);
static_assert(is_reinterpret_castable_v<unit_test_is_reinterpret_castable_polymorphic_base &, unit_test_is_reinterpret_castable_polymorphic_derived_1 &>);
static_assert(is_reinterpret_castable_v<unit_test_is_reinterpret_castable_polymorphic_base &, unit_test_is_reinterpret_castable_polymorphic_derived_2 &>);
static_assert(is_reinterpret_castable_v<unit_test_is_reinterpret_castable_polymorphic_base &, unit_test_is_reinterpret_castable_polymorphic_derived_3 &>);
static_assert(is_reinterpret_castable_v<unit_test_is_reinterpret_castable_polymorphic_derived_1 &, unit_test_is_reinterpret_castable_polymorphic_base &>);
static_assert(is_reinterpret_castable_v<unit_test_is_reinterpret_castable_polymorphic_derived_2 &, unit_test_is_reinterpret_castable_polymorphic_base &>);
static_assert(is_reinterpret_castable_v<unit_test_is_reinterpret_castable_polymorphic_derived_3 &, unit_test_is_reinterpret_castable_polymorphic_base &>);
static_assert(not is_reinterpret_castable_v<unit_test_is_reinterpret_castable_polymorphic_base, unit_test_is_reinterpret_castable_polymorphic_virtual_derived_1>);
static_assert(not is_reinterpret_castable_v<unit_test_is_reinterpret_castable_polymorphic_base, unit_test_is_reinterpret_castable_polymorphic_virtual_derived_2>);
static_assert(not is_reinterpret_castable_v<unit_test_is_reinterpret_castable_polymorphic_base, unit_test_is_reinterpret_castable_polymorphic_virtual_derived_final>);
static_assert(not is_reinterpret_castable_v<unit_test_is_reinterpret_castable_polymorphic_virtual_derived_1, unit_test_is_reinterpret_castable_polymorphic_base>);
static_assert(not is_reinterpret_castable_v<unit_test_is_reinterpret_castable_polymorphic_virtual_derived_2, unit_test_is_reinterpret_castable_polymorphic_base>);
static_assert(not is_reinterpret_castable_v<unit_test_is_reinterpret_castable_polymorphic_virtual_derived_final, unit_test_is_reinterpret_castable_polymorphic_base>);
static_assert(not is_reinterpret_castable_v<unit_test_is_reinterpret_castable_polymorphic_virtual_derived_1, unit_test_is_reinterpret_castable_polymorphic_derived_1>);
static_assert(not is_reinterpret_castable_v<unit_test_is_reinterpret_castable_polymorphic_virtual_derived_2, unit_test_is_reinterpret_castable_polymorphic_derived_1>);
static_assert(not is_reinterpret_castable_v<unit_test_is_reinterpret_castable_polymorphic_virtual_derived_final, unit_test_is_reinterpret_castable_polymorphic_derived_1>);
static_assert(is_reinterpret_castable_v<unit_test_is_reinterpret_castable_polymorphic_base &, unit_test_is_reinterpret_castable_polymorphic_virtual_derived_1 &>);
static_assert(is_reinterpret_castable_v<unit_test_is_reinterpret_castable_polymorphic_base &, unit_test_is_reinterpret_castable_polymorphic_virtual_derived_2 &>);
static_assert(is_reinterpret_castable_v<unit_test_is_reinterpret_castable_polymorphic_base &, unit_test_is_reinterpret_castable_polymorphic_virtual_derived_final &>);
static_assert(is_reinterpret_castable_v<unit_test_is_reinterpret_castable_polymorphic_virtual_derived_1 &, unit_test_is_reinterpret_castable_polymorphic_base &>);
static_assert(is_reinterpret_castable_v<unit_test_is_reinterpret_castable_polymorphic_virtual_derived_2 &, unit_test_is_reinterpret_castable_polymorphic_base &>);
static_assert(is_reinterpret_castable_v<unit_test_is_reinterpret_castable_polymorphic_virtual_derived_final &, unit_test_is_reinterpret_castable_polymorphic_base &>);
static_assert(is_reinterpret_castable_v<unit_test_is_reinterpret_castable_polymorphic_virtual_derived_1 &, unit_test_is_reinterpret_castable_polymorphic_derived_1 &>);
static_assert(is_reinterpret_castable_v<unit_test_is_reinterpret_castable_polymorphic_virtual_derived_2 &, unit_test_is_reinterpret_castable_polymorphic_derived_1 &>);
static_assert(is_reinterpret_castable_v<unit_test_is_reinterpret_castable_polymorphic_virtual_derived_final &, unit_test_is_reinterpret_castable_polymorphic_derived_1 &>);
static_assert(is_reinterpret_castable_v<unit_test_is_reinterpret_castable_polymorphic_base *, unit_test_is_reinterpret_castable_polymorphic_virtual_derived_1 *>);
static_assert(is_reinterpret_castable_v<unit_test_is_reinterpret_castable_polymorphic_base *, unit_test_is_reinterpret_castable_polymorphic_virtual_derived_2 *>);
static_assert(is_reinterpret_castable_v<unit_test_is_reinterpret_castable_polymorphic_base *, unit_test_is_reinterpret_castable_polymorphic_virtual_derived_final *>);
static_assert(is_reinterpret_castable_v<unit_test_is_reinterpret_castable_polymorphic_virtual_derived_1 *, unit_test_is_reinterpret_castable_polymorphic_base *>);
...
static_assert(is_reinterpret_castable_v<unit_test_is_reinterpret_castable_polymorphic_virtual_derived_2 *, unit_test_is_reinterpret_castable_polymorphic_derived_1 *>);
static_assert(is_reinterpret_castable_v<unit_test_is_reinterpret_castable_polymorphic_virtual_derived_final *, unit_test_is_reinterpret_castable_polymorphic_derived_1 *>);
static_assert(not is_reinterpret_castable_v<unit_test_is_reinterpret_castable, int>);
static_assert(not is_reinterpret_castable_v<unit_test_is_reinterpret_castable, char>);
static_assert(not is_reinterpret_castable_v<unit_test_is_reinterpret_castable, double>);
static_assert(not is_reinterpret_castable_v<unit_test_is_reinterpret_castable, void *>);
static_assert(not is_reinterpret_castable_v<unit_test_is_reinterpret_castable, long>);
static_assert(not is_reinterpret_castable_v<unit_test_is_reinterpret_castable, int *>);
static_assert(not is_reinterpret_castable_v<unsigned short, unit_test_is_reinterpret_castable>);
static_assert(not is_reinterpret_castable_v<unsigned short &, unit_test_is_reinterpret_castable>);
static_assert(not is_reinterpret_castable_v<unsigned, unit_test_is_reinterpret_castable>);
static_assert(not is_reinterpret_castable_v<unsigned long, unit_test_is_reinterpret_castable>);
static_assert(is_reinterpret_castable_v<unsigned long, unit_test_is_reinterpret_castable &>);
static_assert(is_reinterpret_castable_v<unsigned long, const unit_test_is_reinterpret_castable &>);
static_assert(not is_reinterpret_castable_v<float, unit_test_is_reinterpret_castable>);
static_assert(not is_reinterpret_castable_v<double, unit_test_is_reinterpret_castable>);
static_assert(is_reinterpret_castable_v<long double, const unit_test_is_reinterpret_castable &>);
static_assert(not is_reinterpret_castable_v<int **, unit_test_is_reinterpret_castable>);        // prefer to operator int **&()
static_assert(not is_reinterpret_castable_v<int **&&, unit_test_is_reinterpret_castable>);      // still prefer to operator int **&()
__DATA_STRUCTURE_END

__DATA_STRUCTURE_START(unit test for ds::is_castable)
struct unit_test_is_castable_base {
    int a;
};
struct unit_test_is_castable_derived : unit_test_is_castable_base {
    int b;
};
struct unit_test_is_castable_polymorphic_base {
    int a;
    virtual ~unit_test_is_castable_polymorphic_base();
};
struct unit_test_is_castable_polymorphic_derived_1 : unit_test_is_castable_polymorphic_base {
    int b;
    virtual ~unit_test_is_castable_polymorphic_derived_1() override;
};
struct unit_test_is_castable_polymorphic_derived_2 : unit_test_is_castable_polymorphic_base {
    int c;
};
struct unit_test_is_castable_polymorphic_derived_3 : unit_test_is_castable_polymorphic_derived_1, unit_test_is_castable_polymorphic_derived_2 {
    int d;
};
struct unit_test_is_castable_polymorphic_virtual_derived_1 : virtual unit_test_is_castable_polymorphic_derived_1 {
    int b;
};
struct unit_test_is_castable_polymorphic_virtual_derived_2 : virtual unit_test_is_castable_polymorphic_derived_1 {
    int c;
};
struct unit_test_is_castable_polymorphic_virtual_derived_final : unit_test_is_castable_polymorphic_virtual_derived_1, unit_test_is_castable_polymorphic_virtual_derived_2 {
    int d;
};
struct unit_test_is_castable {
    unit_test_is_castable() = default;
    unit_test_is_castable(int);
    explicit unit_test_is_castable(char);
    unit_test_is_castable(double) = delete;
    explicit unit_test_is_castable(void *) = delete;
    unit_test_is_castable(int, char);
    explicit unit_test_is_castable(long, long);
    unit_test_is_castable(initializer_list<int *>);
    explicit unit_test_is_castable(initializer_list<char *>);
    unit_test_is_castable(initializer_list<double *>, int, char, long);
    template <typename T, typename U, typename V>
    unit_test_is_castable(T, U &&, V **);
    unit_test_is_castable(void *, void *, void **) = delete;
    operator unsigned short &();
    operator unsigned &() = delete;
    operator const unsigned long &() const &;
    explicit operator float &();
...
static_assert(is_castable_v<int, int>);
static_assert(is_castable_v<int, int &>);
static_assert(is_castable_v<int, int &&>);
static_assert(is_castable_v<int, const int>);
static_assert(is_castable_v<int, volatile int>);
static_assert(is_castable_v<int, const volatile int>);
static_assert(is_castable_v<int, const int &>);
static_assert(is_castable_v<int, volatile int &>);
static_assert(is_castable_v<int, const volatile int &>);
static_assert(is_castable_v<int, const int &&>);
...
static_assert(is_castable_v<int &, int *>);
static_assert(is_castable_v<int &&, int *>);
static_assert(is_castable_v<int, void *>);
static_assert(is_castable_v<int, char *>);
static_assert(is_castable_v<int &, int>);
static_assert(is_castable_v<int &, int &>);
static_assert(is_castable_v<int &, int &&>);
static_assert(is_castable_v<int &, const int>);
...
static_assert(is_castable_v<int &&, volatile int &&>);
static_assert(is_castable_v<int &&, const volatile int &&>);
static_assert(is_castable_v<const int, int>);
static_assert(is_castable_v<const int, int &>);
static_assert(is_castable_v<const int, int &&>);
static_assert(is_castable_v<const int, const int>);
static_assert(is_castable_v<const int, volatile int>);
static_assert(is_castable_v<const int, const volatile int>);
static_assert(is_castable_v<const int, const int &>);
static_assert(is_castable_v<const int, volatile int &>);
static_assert(is_castable_v<const int, const volatile int &>);
static_assert(is_castable_v<const int, const int &&>);
static_assert(is_castable_v<const int, volatile int &&>);
static_assert(is_castable_v<const int, const volatile int &&>);
static_assert(is_castable_v<volatile int, int>);
static_assert(is_castable_v<volatile int, int &>);
static_assert(is_castable_v<volatile int, int &&>);
static_assert(is_castable_v<volatile int, const int>);
static_assert(is_castable_v<volatile int, volatile int>);
static_assert(is_castable_v<volatile int, const volatile int>);
static_assert(is_castable_v<volatile int, const int &>);
static_assert(is_castable_v<volatile int, volatile int &>);
static_assert(is_castable_v<volatile int, const volatile int &>);
static_assert(is_castable_v<volatile int, const int &&>);
static_assert(is_castable_v<volatile int, volatile int &&>);
static_assert(is_castable_v<volatile int, const volatile int &&>);
static_assert(is_castable_v<const volatile int, int>);
static_assert(is_castable_v<const volatile int, int &>);
static_assert(is_castable_v<const volatile int, int &&>);
static_assert(is_castable_v<const volatile int, const int>);
static_assert(is_castable_v<const volatile int, volatile int>);
static_assert(is_castable_v<const volatile int, const volatile int>);
static_assert(is_castable_v<const volatile int, const int &>);
static_assert(is_castable_v<const volatile int, volatile int &>);
static_assert(is_castable_v<const volatile int, const volatile int &>);
static_assert(is_castable_v<const volatile int, const int &&>);
...
static_assert(is_castable_v<const volatile int &&, volatile int &&>);
static_assert(is_castable_v<const volatile int &&, const volatile int &&>);
static_assert(is_castable_v<int, bool>);
static_assert(is_castable_v<int, short>);
static_assert(is_castable_v<int, unsigned short>);
static_assert(is_castable_v<int, char>);
static_assert(is_castable_v<int, unsigned char>);
static_assert(is_castable_v<int, signed char>);
static_assert(is_castable_v<int, unsigned>);
static_assert(is_castable_v<int, long>);
static_assert(is_castable_v<int, unsigned long>);
static_assert(is_castable_v<int, const unsigned>);
static_assert(is_castable_v<int, const long>);
static_assert(is_castable_v<int, const unsigned long>);
static_assert(is_castable_v<int, char8_t>);
static_assert(is_castable_v<int, char16_t>);
static_assert(is_castable_v<int, char32_t>);
static_assert(is_castable_v<int, wchar_t>);
static_assert(is_castable_v<int, float>);
static_assert(is_castable_v<double, float>);
static_assert(is_castable_v<double, int>);
static_assert(is_castable_v<double, unsigned>);
static_assert(is_castable_v<double, long double>);
static_assert(is_castable_v<double, const int>);
static_assert(is_castable_v<double, const unsigned>);
static_assert(not is_castable_v<int *, int []>);
static_assert(not is_castable_v<const int *, int []>);
static_assert(not is_castable_v<int *const, int []>);
static_assert(not is_castable_v<const int *const, int []>);
static_assert(not is_castable_v<int *, int [42]>);
static_assert(not is_castable_v<const int *, int [42]>);
static_assert(not is_castable_v<int *const, int [42]>);
static_assert(not is_castable_v<const int *const, int [42]>);
static_assert(not is_castable_v<int [], initializer_list<int>>);
static_assert(not is_castable_v<int [42], initializer_list<int>>);
static_assert(not is_castable_v<int *, initializer_list<int>>);
static_assert(not is_castable_v<int (&)[], int []>);
static_assert(not is_castable_v<int (&&)[], int []>);
static_assert(not is_castable_v<int (&)[42], int [42]>);
static_assert(not is_castable_v<int (&&)[42], int [42]>);
static_assert(not is_castable_v<int (&)[], initializer_list<int>>);
static_assert(not is_castable_v<int (&)[42], initializer_list<int>>);
static_assert(is_castable_v<int *, int (&)[]>);
static_assert(is_castable_v<int *, int (&&)[]>);
static_assert(is_castable_v<int *, int (&)[42]>);
static_assert(is_castable_v<int *, int (&&)[42]>);
static_assert(is_castable_v<const int *, int (&)[]>);
static_assert(is_castable_v<const int *, int (&&)[]>);
static_assert(is_castable_v<const int *, int (&)[42]>);
static_assert(is_castable_v<const int *, int (&&)[42]>);
static_assert(is_castable_v<int *const, int (&)[]>);
static_assert(is_castable_v<int *const, int (&&)[]>);
static_assert(is_castable_v<int *const, int (&)[42]>);
static_assert(is_castable_v<int *const, int (&&)[42]>);
static_assert(is_castable_v<const int *const, int (&)[]>);
static_assert(is_castable_v<const int *const, int (&&)[]>);
static_assert(is_castable_v<const int *const, int (&)[42]>);
static_assert(is_castable_v<const int *const, int (&&)[42]>);
static_assert(not is_castable_v<void (*)(), void ()>);
static_assert(not is_castable_v<void (), void ()>);
static_assert(not is_castable_v<void (&)(), void ()>);
static_assert(not is_castable_v<void (&&)(), void ()>);
static_assert(is_castable_v<void (&)(), void (&&)()>);
static_assert(is_castable_v<void (&&)(), void (&)()>);
static_assert(is_castable_v<void (*)(), void (&)()>);
static_assert(is_castable_v<void (*)(), void (&&)()>);
static_assert(not is_castable_v<void (*const)(), void ()>);
static_assert(is_castable_v<void (*const)(), void (&)()>);
static_assert(is_castable_v<void (*const)(), void (&&)()>);
static_assert(is_castable_v<int *, void *>);
static_assert(is_castable_v<int *, void *const>);
static_assert(is_castable_v<int *, const void *>);
static_assert(is_castable_v<int *, const void *const >);
static_assert(is_castable_v<int *const, void *>);
static_assert(is_castable_v<const int *, void *>);
static_assert(is_castable_v<int [], void *>);
static_assert(is_castable_v<int [], void *const>);
static_assert(is_castable_v<int [], const void *>);
static_assert(is_castable_v<int [], const void *const>);
static_assert(is_castable_v<int [42], void *>);
static_assert(is_castable_v<int [42], void *const>);
static_assert(is_castable_v<int [42], const void *>);
static_assert(is_castable_v<int [42], const void *const>);
static_assert(is_castable_v<const int [], void *>);
static_assert(is_castable_v<const int [], const void *>);
static_assert(is_castable_v<const int [42], const void *>);
static_assert(is_castable_v<int (&)[], void *>);
static_assert(is_castable_v<int (&)[], void *const>);
static_assert(is_castable_v<int (&)[], const void *>);
static_assert(is_castable_v<int (&)[], const void *const>);
...
static_assert(is_castable_v<void (), void *>);
static_assert(is_castable_v<void (*)(), void *>);
static_assert(not is_castable_v<void (A::*)(), void *>);
static_assert(is_castable_v<__int128_t, int>);
static_assert(is_castable_v<__uint128_t, int>);
static_assert(is_castable_v<__int128_t, unsigned>);
static_assert(is_castable_v<__uint128_t, unsigned>);
static_assert(is_castable_v<__int128_t, double>);
static_assert(is_castable_v<__uint128_t, double>);
static_assert(is_castable_v<int, C>);
static_assert(is_castable_v<int, D>);
static_assert(is_castable_v<C, int>);
static_assert(is_castable_v<D, int>);
static_assert(is_castable_v<D, short>);
static_assert(is_castable_v<D, bool>);
static_assert(is_castable_v<D, unsigned>);
static_assert(is_castable_v<D, unit_test_is_castable>);
static_assert(not is_castable_v<unit_test_is_castable_base, unit_test_is_castable_derived>);
static_assert(is_castable_v<unit_test_is_castable_derived, unit_test_is_castable_base>);
static_assert(is_castable_v<unit_test_is_castable_base *, unit_test_is_castable_derived *>);
static_assert(is_castable_v<unit_test_is_castable_derived *, unit_test_is_castable_base *>);
static_assert(is_castable_v<unit_test_is_castable_base *, const unit_test_is_castable_derived *>);
static_assert(is_castable_v<unit_test_is_castable_derived *, const unit_test_is_castable_base *>);
static_assert(is_castable_v<unit_test_is_castable_base *, unit_test_is_castable_derived *const>);
static_assert(is_castable_v<unit_test_is_castable_derived *, unit_test_is_castable_base *const>);
static_assert(is_castable_v<unit_test_is_castable_base *, const unit_test_is_castable_derived *const>);
static_assert(is_castable_v<unit_test_is_castable_derived *, const unit_test_is_castable_base *const>);
static_assert(is_castable_v<const unit_test_is_castable_base *, unit_test_is_castable_derived *>);
static_assert(is_castable_v<const unit_test_is_castable_derived *, unit_test_is_castable_base *>);
static_assert(is_castable_v<const unit_test_is_castable_base *, const unit_test_is_castable_derived *>);
static_assert(is_castable_v<const unit_test_is_castable_derived *, const unit_test_is_castable_base *>);
static_assert(is_castable_v<const unit_test_is_castable_base *, unit_test_is_castable_derived *const>);
static_assert(is_castable_v<const unit_test_is_castable_derived *, unit_test_is_castable_base *const>);
static_assert(is_castable_v<const unit_test_is_castable_base *, const unit_test_is_castable_derived *const>);
static_assert(is_castable_v<const unit_test_is_castable_derived *, const unit_test_is_castable_base *const>);
static_assert(is_castable_v<unit_test_is_castable_base *const, unit_test_is_castable_derived *>);
static_assert(is_castable_v<unit_test_is_castable_derived *const, unit_test_is_castable_base *>);
static_assert(is_castable_v<unit_test_is_castable_base *const, const unit_test_is_castable_derived *>);
static_assert(is_castable_v<unit_test_is_castable_derived *const, const unit_test_is_castable_base *>);
static_assert(is_castable_v<unit_test_is_castable_base *const, unit_test_is_castable_derived *const>);
static_assert(is_castable_v<unit_test_is_castable_derived *const, unit_test_is_castable_base *const>);
static_assert(is_castable_v<unit_test_is_castable_base *const, const unit_test_is_castable_derived *const>);
static_assert(is_castable_v<unit_test_is_castable_derived *const, const unit_test_is_castable_base *const>);
static_assert(is_castable_v<const unit_test_is_castable_base *const, unit_test_is_castable_derived *>);
static_assert(is_castable_v<const unit_test_is_castable_derived *const, unit_test_is_castable_base *>);
static_assert(is_castable_v<const unit_test_is_castable_base *const, const unit_test_is_castable_derived *>);
static_assert(is_castable_v<const unit_test_is_castable_derived *const, const unit_test_is_castable_base *>);
static_assert(is_castable_v<const unit_test_is_castable_base *const, unit_test_is_castable_derived *const>);
static_assert(is_castable_v<const unit_test_is_castable_derived *const, unit_test_is_castable_base *const>);
static_assert(is_castable_v<const unit_test_is_castable_base *const, const unit_test_is_castable_derived *const>);
static_assert(is_castable_v<const unit_test_is_castable_derived *const, const unit_test_is_castable_base *const>);
static_assert(is_castable_v<unit_test_is_castable_base &, unit_test_is_castable_derived &>);
static_assert(is_castable_v<unit_test_is_castable_base &, unit_test_is_castable_derived &&>);
static_assert(is_castable_v<unit_test_is_castable_derived &, unit_test_is_castable_base &>);
static_assert(is_castable_v<unit_test_is_castable_derived &, unit_test_is_castable_base &&>);
...
static_assert(is_castable_v<const unit_test_is_castable_derived &&, const unit_test_is_castable_base &>);
static_assert(is_castable_v<const unit_test_is_castable_derived &&, const unit_test_is_castable_base &&>);
static_assert(not is_castable_v<unit_test_is_castable_polymorphic_base, unit_test_is_castable_polymorphic_derived_1>);
static_assert(not is_castable_v<unit_test_is_castable_polymorphic_base, unit_test_is_castable_polymorphic_derived_2>);
static_assert(not is_castable_v<unit_test_is_castable_polymorphic_base, unit_test_is_castable_polymorphic_derived_3>);
static_assert(is_castable_v<unit_test_is_castable_polymorphic_derived_1, unit_test_is_castable_polymorphic_base>);
static_assert(is_castable_v<unit_test_is_castable_polymorphic_derived_2, unit_test_is_castable_polymorphic_base>);
static_assert(not is_castable_v<unit_test_is_castable_polymorphic_derived_3, unit_test_is_castable_polymorphic_base>);
static_assert(is_castable_v<unit_test_is_castable_polymorphic_base *, unit_test_is_castable_polymorphic_derived_1 *>);
static_assert(is_castable_v<unit_test_is_castable_polymorphic_base *, unit_test_is_castable_polymorphic_derived_2 *>);
static_assert(not is_castable_v<unit_test_is_castable_polymorphic_base *, unit_test_is_castable_polymorphic_derived_3 *>);
static_assert(is_castable_v<unit_test_is_castable_polymorphic_derived_1 *, unit_test_is_castable_polymorphic_base *>);
static_assert(is_castable_v<unit_test_is_castable_polymorphic_derived_2 *, unit_test_is_castable_polymorphic_base *>);
static_assert(not is_castable_v<unit_test_is_castable_polymorphic_derived_3 *, unit_test_is_castable_polymorphic_base *>);
...
static_assert(is_castable_v<unit_test_is_castable_polymorphic_derived_2 &, unit_test_is_castable_polymorphic_base &>);
static_assert(not is_castable_v<unit_test_is_castable_polymorphic_derived_3 &, unit_test_is_castable_polymorphic_base &>);
static_assert(not is_castable_v<unit_test_is_castable_polymorphic_base, unit_test_is_castable_polymorphic_virtual_derived_1>);
static_assert(not is_castable_v<unit_test_is_castable_polymorphic_base, unit_test_is_castable_polymorphic_virtual_derived_2>);
static_assert(not is_castable_v<unit_test_is_castable_polymorphic_base, unit_test_is_castable_polymorphic_virtual_derived_final>);
static_assert(is_castable_v<unit_test_is_castable_polymorphic_virtual_derived_1, unit_test_is_castable_polymorphic_base>);
static_assert(is_castable_v<unit_test_is_castable_polymorphic_virtual_derived_2, unit_test_is_castable_polymorphic_base>);
static_assert(is_castable_v<unit_test_is_castable_polymorphic_virtual_derived_final, unit_test_is_castable_polymorphic_base>);
static_assert(is_castable_v<unit_test_is_castable_polymorphic_virtual_derived_1, unit_test_is_castable_polymorphic_derived_1>);
static_assert(is_castable_v<unit_test_is_castable_polymorphic_virtual_derived_2, unit_test_is_castable_polymorphic_derived_1>);
static_assert(is_castable_v<unit_test_is_castable_polymorphic_virtual_derived_final, unit_test_is_castable_polymorphic_derived_1>);
static_assert(not is_castable_v<unit_test_is_castable_polymorphic_base &, unit_test_is_castable_polymorphic_virtual_derived_1 &>);
static_assert(not is_castable_v<unit_test_is_castable_polymorphic_base &, unit_test_is_castable_polymorphic_virtual_derived_2 &>);
static_assert(not is_castable_v<unit_test_is_castable_polymorphic_base &, unit_test_is_castable_polymorphic_virtual_derived_final &>);
static_assert(is_castable_v<unit_test_is_castable_polymorphic_virtual_derived_1 &, unit_test_is_castable_polymorphic_base &>);
...
static_assert(is_castable_v<unit_test_is_castable_polymorphic_virtual_derived_2 *, unit_test_is_castable_polymorphic_derived_1 *>);
static_assert(is_castable_v<unit_test_is_castable_polymorphic_virtual_derived_final *, unit_test_is_castable_polymorphic_derived_1 *>);
static_assert(is_castable_v<unit_test_is_castable, int>);
static_assert(not is_castable_v<unit_test_is_castable, char>);
static_assert(not is_castable_v<unit_test_is_castable, double>);
static_assert(not is_castable_v<unit_test_is_castable, void *>);
static_assert(not is_castable_v<unit_test_is_castable, long>);
static_assert(not is_castable_v<unit_test_is_castable, int *>);
static_assert(is_castable_v<unsigned short, unit_test_is_castable>);
static_assert(is_castable_v<unsigned short &, unit_test_is_castable>);
static_assert(not is_castable_v<unsigned, unit_test_is_castable>);
static_assert(not is_castable_v<unsigned long, unit_test_is_castable>);
static_assert(is_castable_v<unsigned long, unit_test_is_castable &>);
static_assert(not is_castable_v<unsigned long, const unit_test_is_castable &>);
static_assert(not is_castable_v<float, unit_test_is_castable>);
static_assert(not is_castable_v<double, unit_test_is_castable>);
static_assert(not is_castable_v<long double, const unit_test_is_castable &>);
static_assert(not is_castable_v<int **, unit_test_is_castable>);        // prefer to operator int **&()
static_assert(not is_castable_v<int **&&, unit_test_is_castable>);      // still prefer to operator int **&()
__DATA_STRUCTURE_END